...
CHARACTERSET UTF8
APPEND
INTO TABLE WK_NEW_TANPIN_SUMMARY_SABUN
TRAILING NULLCOLS
(
    ...
    BUNRUI1_CD                     POSITION(351:354) CHAR,
    BUNRUI2_CD                     POSITION(355:359) CHAR,
    BUNRUI5_CD                     POSITION(360:365) CHAR,
    END_HANBAI_TS                  POSITION(366:371) CHAR,
    MM_POINT_TAISYO_KB             POSITION(372:372) CHAR
)