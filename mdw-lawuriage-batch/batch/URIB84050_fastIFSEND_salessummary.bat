...
REM ----------------------------------------------------------------------------
REM  JOB-ID      : URIB84050
REM  BATCH-ID    : URIB84050_fastIFSEND_salessummary.bat
REM  IF          : MDware => FAST
REM  IF-NAME     :�yFAST��I/F�z�y�C�����g���̔���T�}���[�t�@�C���̑��M����
...
SET INFILENAME=fast_sales_summary_per_payment_????????.csv

REM (3)COPY-TO-DIR 
SET SND_TO_DIR=Z:\

REM (4)COPY-TO-FILE-NAME
SET OUTFILENAME=fast_sales_summary_per_payment_????????.csv
