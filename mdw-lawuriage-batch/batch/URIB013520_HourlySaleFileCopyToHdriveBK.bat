...
REM ----------------------------------------------------------------------------
REM (1)BATCH-ID 
SET BAT_ID=URIB013520_HourlySaleFile_CopyToHdriveBkup
...
REM SET INFILENAME=R???????.???
SET INFILENAME=R???????.%2

REM (3)COPY-TO-DIR
REM SET SND_TO_DIR=H:\POS\q5\mdware\upload\R\backup\%BKUPDIR%\
