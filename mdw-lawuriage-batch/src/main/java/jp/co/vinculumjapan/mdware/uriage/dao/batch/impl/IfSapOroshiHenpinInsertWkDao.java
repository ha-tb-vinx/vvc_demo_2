...
/**
 * <p>
 * タイトル：IfSapOroshiHenpinInsertWkDao クラス
 * </p>
 * <p>
 * 説明：SAP IF 卸返品 ワーク作成処理
 * </p>
 * <p>
 ...
 */
public class IfSapOroshiHenpinInsertWkDao implements DaoIf {

    /** バッチID */
    private static final String BATCH_ID = "URIB810100";
    /** バッチ名 */
    private static final String BATCH_NAME = "SAP IF 卸返品 ワーク作成処理";
    /** バッチ日 */
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        /** ログを出力 */
        invoker.infoLog(strUserId + "　：　SAP IF 卸返品 ワーク作成処理を開始します。");
        ...
        // 実行後処理
        // ログを出力する
        invoker.infoLog(strUserId + "　：　SAP IF 卸返品 ワーク作成処理を終了します。");
    }
    
    private String insertWKColumn(){
        StringBuffer sb = new StringBuffer();
        sb.append(" INSERT ");
        sb.append(" INTO WK_SAP_OROSHI_HENPIN(  ");
        sb.append("   HENKOU_KB ");
        sb.append("   , REF_1 ");
        sb.append("   , MEISAI_KB ");
    ...
    private String insertWK_C_Header() {
        ...
        sb.append("   , DOSD.CYOHYO_DENPYO_NO || '07' || SUBSTR(TO_CHAR(DOSD.DENPYO_EDA_RB, 999),-1) AS REF_1 ");
        ...
        sb.append("   , NVL(DOSD.INVOICE_KEYINNO_NB, DOSD.OROSHI_VAT_KEYINNO_NB) ");//KEYINのVAT番号はFIVIが発行か卸先が持込かで、どちらかしか値は入らない
        sb.append("   , NVL(DOSD.INVOICE_KEYINNO_KB, DOSD.OROSHI_VAT_KEYINNO_KB) ");//そのため優先順は1.KEYIN > 2.卸KEYINとする
        sb.append("   , NVL(DOSD.INVOICE_KEYINNO_RB, DOSD.OROSHI_VAT_KEYINNO_RB) ");
        sb.append("   , DOSD.VAT_KB AS INVOICE_HAKOU_KB ");
        sb.append("   , NVL( ");                                //・FIVIがKEYINしたVAT日付または相手方が持ち込んだVAT日付は、画面ではVATの「発行日」に手入力する
        sb.append("       NVL(DOSD.INVOICE_KEYINNO_HAKOU_DT "); //・VAT発行日はFIVIが発行（KEYINとAUTOは同じ）か卸先が持込かで、どちらかしか値は入らない
        sb.append("          ,DOSD.INVOICE_AUTONO_HAKOU_DT ");  //  そのため優先順は1.KEYIN > 2.AUTO > 3.卸KEYIN とする
        sb.append("       ) ");
        sb.append("       , DOSD.OROSHI_VAT_KEYINNO_HAKOU_DT ");
        sb.append("     ) AS INVOICE_HAKOU_DT ");
        sb.append(" FROM ");
        ...
        sb.append("   AND DOSD.DENPYO_KB = '02'  ");//返品
    ...
    private String insertWK_C_Meisai() {
        ...
        sb.append("   , DOSD.INVOICE_AUTONO_KB ");
        sb.append("   , DOSD.INVOICE_AUTONO_RB ");
        sb.append("   , DOSD.CYOHYO_DENPYO_NO || '07' || SUBSTR(TO_CHAR(DOSD.DENPYO_EDA_RB, 999),-1) ");
        sb.append("   , CASE  ");
        sb.append("     WHEN TRIM(OROSHI_ZEI_KB) IS NOT NULL  ");
        sb.append("     THEN CASE  ");
        sb.append("       WHEN TO_NUMBER(TRIM(OROSHI_ZEI_KB)) = 3  ");
        ...
        sb.append("   , NVL(DOSD.INVOICE_KEYINNO_RB, DOSD.OROSHI_VAT_KEYINNO_RB) ");
        sb.append("   , DOSD.VAT_KB ");
        sb.append("   , NVL( ");
        sb.append("       NVL(DOSD.INVOICE_KEYINNO_HAKOU_DT ");
        sb.append("          ,DOSD.INVOICE_AUTONO_HAKOU_DT "); 
        sb.append("       ) ");
        sb.append("       , DOSD.OROSHI_VAT_KEYINNO_HAKOU_DT ");
        sb.append("     ) ");
    ...
    private String insertWK_D_Header() {
        ...
        sb.append("   , NVL(DOSD.INVOICE_KEYINNO_RB, DOSD.OROSHI_VAT_KEYINNO_RB) ");
        sb.append("   , DOSD.VAT_KB AS INVOICE_HAKOU_KB ");
        sb.append("   , NVL( ");                                //・FIVIがKEYINしたVAT日付または卸先が持ち込んだVAT日付は、画面ではVATの「発行日」に手入力する
        sb.append("       NVL(DOSD.INVOICE_KEYINNO_HAKOU_DT "); //・VAT発行日はFIVIが発行（KEYINとAUTOは同じ）か卸先が持込かで、どちらかしか値は入らない
        sb.append("          ,DOSD.INVOICE_AUTONO_HAKOU_DT ");  //  そのため優先順は1.KEYIN > 2.AUTO > 3.卸KEYIN とする
        sb.append("       ) ");
        sb.append("       , DOSD.OROSHI_VAT_KEYINNO_HAKOU_DT ");
        ...
        sb.append(" WHERE ");
        sb.append("   DOSD.COMP_CD = '"+COMP_CD+"'  ");
        sb.append("   AND DOSD.DENPYO_KB = '02'  ");
        sb.append("   AND DOSD.SYORI_STATUS_KB = '2'  ");
        sb.append("   AND DOSD.DELETE_FG = '0'  ");
    ...
    private String truncateWK() {
        StringBuffer sb = new StringBuffer();
        sb.append(" TRUNCATE TABLE WK_SAP_OROSHI_HENPIN ");
        return sb.toString();
    }
