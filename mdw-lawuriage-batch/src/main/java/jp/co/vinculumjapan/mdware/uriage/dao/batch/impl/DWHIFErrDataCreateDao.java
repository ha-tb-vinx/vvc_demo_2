...
/**
 *  <P>タイトル: DWHIFErrDataCreateDao クラス</p>
 *  <P>説明: </p>
 ...
 */
public class DWHIFErrDataCreateDao implements DaoIf {

    /** バッチ処理名 */
    private static final String BATCH_NAME = "ＤＷＨIF用エラーデータ作成処理";
    /** バッチID */
    private static final String BATCH_ID = "URIB131100";
    /** DB日付取得 */
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　ＤＷＨＳ：ＤＷＨIF用エラーデータ作成処理を開始します。");
        invoker.infoLog(strUserID + "　：　ＤＷＨIF用エラーデータ:ＤＷＨIF用エラーデータ挿入処理を開始します。");

        // ＤＷＨIF用エラーデータ挿入処理
        // SQLを取得し、パラメータを条件にバインドする
        int IDX = 1;
        preparedStatementIns = invoker.getDataBase().prepareStatement(insDWHIFErrSql());
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　" + intInsertCount + "件のＤＷＨIF用エラーデータを挿入しました。");
        invoker.infoLog(strUserID + "　：　ＤＷＨIF用エラーデータ:ＤＷＨIF用エラーデータ挿入処理を終了します。");
        invoker.infoLog(strUserID + "　：　ＤＷＨＳ：ＤＷＨIF用エラーデータ作成処理を終了します。");
    }

    private String insDWHIFErrSql() {
        StringBuffer sb = new StringBuffer("");
        
        // ＤＷＨIF用エラーデータ作成用InsertSQL構築
        sb.append(" INSERT INTO ");
        sb.append("    DT_ERR_DWH_IF ");
        sb.append("    ( ");
        sb.append("          COMP_CD ");
        sb.append("        , SEQ_RB ");
        sb.append("        , URIAGE_DT ");
        ...
        sb.append("        SELECT ");
        sb.append("              COMP_CD ");
        sb.append("            , SEQ_DT_ERR_DWH_IF.NEXTVAL ");
        sb.append("            , URIAGE_DT ");
        sb.append("            , URIAGE_TM ");
        sb.append("            , KIGYO1_CD ");
        sb.append("            , KIGYO2_CD ");
