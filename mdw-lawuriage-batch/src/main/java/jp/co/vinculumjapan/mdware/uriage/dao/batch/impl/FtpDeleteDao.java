 ...
 */
public class FtpDeleteDao implements DaoIf {

    FtpDeleteDaoInputBean input_ = null;
    ...
    public void executeDataAccess(DaoInvokerIf invokerIf) throws Exception {
        ...
        try {
            ...
            // ファイル削除
            if (!fp.deleteFile(remoteDirName + "/" + input_.getRemoteFileName())) {
                invokerIf.infoLog(invokerIf.getUserId() + "：FTPファイル削除処理に失敗しました。");
                throw new DaoException(invokerIf.getUserId() + "：FTPファイル削除処理に失敗しました。");
            }
        ...
        invokerIf.infoLog(invokerIf.getUserId() + "：FTP削除処理が完了しました。");
    }
    ...
    public void setInputObject(Object obj) {
        input_ = (FtpDeleteDaoInputBean) obj;
    }
}