...
/**
 * 
 * <p>タイトル: JikantaiZenkaiTanpinUriageSakuseiDaoInputBean.java クラス</p>
 * <p>説明　: 前回時間帯単品売上データ作成処理InputBean</p>
 * <p>著作権: Copyright (c) 2013</p>
 * <p>会社名: VINX</p>
 * @version 3.00 (2013.10.28) T.Ooshiro [CUS00057] ランドローム様対応 POSインターフェイス仕様変更対応 結合テスト課題対応 №058
 *
 */
public class JikantaiZenkaiTanpinUriageSakuseiDaoInputBean {
