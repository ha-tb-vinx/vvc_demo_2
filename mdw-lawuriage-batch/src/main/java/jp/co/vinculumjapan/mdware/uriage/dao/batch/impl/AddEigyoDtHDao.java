...
/**
 *
 * <p>タイトル: AddEigyoDtHDao.java クラス</p>
 * <p>説明　: 営業日付加</p>
 * <p>著作権: Copyright (c) 2013</p>
 * <p>会社名: VINX</p>
 * @Version 1.00  (2016.11.01) k.Hyo FIVI対応
 *
 */
public class AddEigyoDtHDao implements DaoIf {
    ...
    /** 削除SQL */
    private static final String DEL_SQL = "TRUNCATE TABLE TMP_POS_H_HAMPER";
    //20160616 T.KAMEI ADD (E)

    /** 登録先テーブル名称(POSジャーナル一時データ) */
    private static final String TMP_POS_H_HAMPER = "POSジャーナル（C_Payment）一時データ";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        try {
            ...
            // TMP_POS_C_PAYMENT
            invoker.infoLog(strUserId + "　：　" + TMP_POS_H_HAMPER + "の出力を開始します。");
            preparedStatementExIns = invoker.getDataBase().prepareStatement(getEigyoDtInsertSql());
            insertCount = preparedStatementExIns.executeUpdate();
            // ログ出力
            invoker.infoLog(strUserId + "　：　" + insertCount + "件の" + TMP_POS_H_HAMPER + "を出力しました。");
            invoker.infoLog(strUserId + "　：　" + TMP_POS_H_HAMPER + "の出力を終了します。");
    ...
    private String getEigyoDtInsertSql() {
        ...
        sql.append("FROM ");
        sql.append("    TMP_POS_H_HAMPER_WK A ");
