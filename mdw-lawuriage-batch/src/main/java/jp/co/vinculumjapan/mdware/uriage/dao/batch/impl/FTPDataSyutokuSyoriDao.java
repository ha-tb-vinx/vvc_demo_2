...
import jp.co.vinculumjapan.mdware.uriage.dao.batch.input.FTPDataSyutokuSyoriDaoInputBean;
...
/**
 *  <P>タイトル: FTPDataSyutokuSyoriDao クラス</p>
 *  <P>説明: FTPデータ取得処理です。</p>
 ...
 *  @version 1.0 
 */
public class FTPDataSyutokuSyoriDao implements DaoIf {

    /** バッチ処理名 */
    private static final String BATCH_NAME = "FTPデータ取得処理";
    /** サーバアドレス */
    ...
    /** インプットビーン */
    private FTPDataSyutokuSyoriDaoInputBean inputBean = null;
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　FTPデータ取得処理を開始します。");
        ...
        while (itNames.hasNext()) {
            ...
            // FTP受信処理DAOを実行する
            FtpGetDao FtpGetDao = new FtpGetDao();

            // 入力ビーンインスタンス生成
            FtpGetDaoInputBean inputBean = new FtpGetDaoInputBean();
            // 項目転送内容を設定する
            // サーバアドレス
            ...
            // 入力ビーンビーンをセット
            FtpGetDao.setInputObject(inputBean);

            // データアクセスオブジェクトのビジネスロジック実行 
            invoker.InvokeDao(FtpGetDao);
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　FTPデータ取得処理を終了します。");
    ...
    public void setInputObject(Object input) throws Exception {
        inputBean = (FTPDataSyutokuSyoriDaoInputBean) input;
    }
