...
import jp.co.vinculumjapan.mdware.uriage.dao.batch.input.FTPDataDeleteSyoriDaoInputBean;
import jp.co.vinculumjapan.mdware.uriage.dao.batch.input.FtpDeleteDaoInputBean;
...
/**
 *  <P>タイトル: FTPDataDeleteSyoriDao クラス</p>
 *  <P>説明: FTPデータ削除処理です。</p>
 ...
 */
public class FTPDataDeleteSyoriDao implements DaoIf {

    /** バッチ処理名 */
    private static final String BATCH_NAME = "FTPデータ削除処理";
    /** サーバアドレス */
    ...
    /** インプットビーン */
    private FTPDataDeleteSyoriDaoInputBean inputBean = null;
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　FTPデータ削除処理を開始します。");
        ...
        while (itNames.hasNext()) {
            ...
            // FTP受信処理DAOを実行する
            FtpDeleteDao FtpDeleteDao = new FtpDeleteDao();

            // 入力ビーンインスタンス生成
            FtpDeleteDaoInputBean inputBean = new FtpDeleteDaoInputBean();
            // 項目転送内容を設定する
            // サーバアドレス
            ...
            // 入力ビーンビーンをセット
            FtpDeleteDao.setInputObject(inputBean);

            // データアクセスオブジェクトのビジネスロジック実行 
            invoker.InvokeDao(FtpDeleteDao);
            
            // ログ出力
            invoker.infoLog(strUserID + "　：　" + strFileName + "の削除処理が成功しました。");
        }

        // ログ出力
        invoker.infoLog(strUserID + "　：　FTPデータ削除処理を終了します。");
    ...
    public void setInputObject(Object input) throws Exception {
        inputBean = (FTPDataDeleteSyoriDaoInputBean) input;
    }

    public static void main(String[] arg) {
        try {
            DaoIf dao = new FTPDataDeleteSyoriDao();
