...
/**
 *
 * <p>タイトル: AddEigyoDtKDao.java クラス</p>
 * <p>説明　: 営業日付加</p>
 ...
 *
 */
public class AddEigyoDtKDao implements DaoIf {
    ...
    /** 削除SQL */
    private static final String DEL_SQL = "TRUNCATE TABLE TMP_POS_K_DISCOUNT";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        try {
            ...
            // TMP_POS_C_PAYMENT
            invoker.infoLog(strUserId + "　：　" + TMP_POS_K_DISCOUNT + "の出力を開始します。");
            preparedStatementExIns = invoker.getDataBase().prepareStatement(getEigyoDtInsertSql());
            insertCount = preparedStatementExIns.executeUpdate();
            // ログ出力
            invoker.infoLog(strUserId + "　：　" + insertCount + "件の" + TMP_POS_K_DISCOUNT + "を出力しました。");
            invoker.infoLog(strUserId + "　：　" + TMP_POS_K_DISCOUNT + "の出力を終了します。");
    ...
    private String getEigyoDtInsertSql() {
        ...
        sql.append("    ,A.DISC_SUBCTGR ");
        sql.append("    ,A.DISC_AMT ");
        sql.append("    ,B.EIGYO_DT ");
        sql.append("FROM ");
        sql.append("    TMP_POS_K_DISCOUNT_WK A ");
