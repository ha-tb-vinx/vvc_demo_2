...
/**
 *  <P>タイトル: OnMemoryIfDptUchiUriDataSendDao クラス</p>
 *  <P>説明: URIB061090 DPT打ち売上データFTP送信処理</p>
 *  <P>著作権: Copyright (c) 2009</p>
 *  <P>会社名: Vinculum Japan Corporation</P>
 *  @author A.Shinsaka
 *  @version 1.0 
 */
public class OnMemoryIfDptUchiUriDataSendDao implements DaoIf {
    ...
    // DPT打ち売上データ
    private static final String FILE_DT_TEN_DPTUCHI_URI = "IF_DT_TEN_DPTUCHI_URI.csv";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　DPT打ち売上データFTP送信処理を開始します。");
        
        // DPT打ち売上データをFTP送信
        sendFileToFtp(invoker, FILE_DT_TEN_DPTUCHI_URI, PATH_KIKAN_RECV_ONMEMO);

        // ログ出力
        invoker.infoLog(strUserID + "　：　DPT打ち売上データFTP送信処理処理を終了します。");
    ...
    public static void main(String[] arg) {
        try {
            DaoIf dao = new OnMemoryIfDptUchiUriDataSendDao();
