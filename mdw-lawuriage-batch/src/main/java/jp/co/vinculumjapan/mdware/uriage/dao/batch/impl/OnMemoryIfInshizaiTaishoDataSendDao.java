...
/**
 *  <P>タイトル: OnMemoryIfInshizaiTaishoDataSendDao クラス</p>
 *  <P>説明: URIB061060 印紙税件数データFTP送信処理</p>
 *  <P>著作権: Copyright (c) 2009</p>
 *  <P>会社名: Vinculum Japan Corporation</P>
 *  @author A.Shinsaka
 *  @version 1.0 
 */
public class OnMemoryIfInshizaiTaishoDataSendDao implements DaoIf {
    ...
    // オンメモリ処理済データ格納ディレクトリパス
    private static final String PATH_KIKAN_RECV_ONMEMO = FiResorceUtility.getPropertie("PATH_KIKAN_RECV_ONMEMO");
    // 印紙税件数データ
    private static final String FILE_DT_INSHIZEI_TAISYO = "IF_DT_INSHIZEI_TAISYO.csv";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　印紙税件数データFTP送信処理を開始します。");
        
        // 印紙税件数データをFTP送信
        sendFileToFtp(invoker, FILE_DT_INSHIZEI_TAISYO, PATH_KIKAN_RECV_ONMEMO);

        // ログ出力
        invoker.infoLog(strUserID + "　：　印紙税件数データFTP送信処理を終了します。");
    ...
    public static void main(String[] arg) {
        try {
            DaoIf dao = new OnMemoryIfInshizaiTaishoDataSendDao();
