...
/**
 *
 * <p>タイトル: AddEigyoDtTDao.java クラス</p>
 * <p>説明　: 営業日付加</p>
 ...
 *
 */
public class AddEigyoDtTDao implements DaoIf {
    ...
    /** 削除SQL */
    private static final String DEL_SQL = "TRUNCATE TABLE TMP_POS_T_TRAILER";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        try {
            ...
            // TMP_POS_C_PAYMENT
            invoker.infoLog(strUserId + "　：　" + TMP_POS_T_TRAILER + "の出力を開始します。");
            preparedStatementExIns = invoker.getDataBase().prepareStatement(getEigyoDtInsertSql());
            insertCount = preparedStatementExIns.executeUpdate();
            // ログ出力
            invoker.infoLog(strUserId + "　：　" + insertCount + "件の" + TMP_POS_T_TRAILER + "を出力しました。");
            invoker.infoLog(strUserId + "　：　" + TMP_POS_T_TRAILER + "の出力を終了します。");
    ...
    private String getEigyoDtInsertSql() {
        ...
        sql.append(",FORMAT ");
        sql.append(",SNI_LINE_COUNT");
        sql.append(",SNI_TOTAL_SALES_AMOUNT ");
        sql.append(",SNI_TOTAL_REDEEM_COUPON ");
        sql.append(",SNI_VALUE_REDEEM_COUPON ");
        sql.append(",SNI_SALES_RCPT_COUNT ");
        sql.append(",SNI_RETURN_RCPT_COUNT ");
        sql.append(",SNI_ROUNDING_AMT ");
        sql.append(",EIGYO_DT) ");
        sql.append("( ");
        ...
        sql.append("    ,A.FORMAT ");
        sql.append("    ,A.SNI_LINE_COUNT");
        sql.append("    ,A.SNI_TOTAL_SALES_AMOUNT ");
        sql.append("    ,A.SNI_TOTAL_REDEEM_COUPON ");
        sql.append("    ,A.SNI_VALUE_REDEEM_COUPON ");
        sql.append("    ,A.SNI_SALES_RCPT_COUNT ");
        sql.append("    ,A.SNI_RETURN_RCPT_COUNT ");
        sql.append("    ,A.SNI_ROUNDING_AMT ");
        sql.append("    ,B.EIGYO_DT ");
        sql.append("FROM ");
        sql.append("    TMP_POS_T_TRAILER_WK A ");
