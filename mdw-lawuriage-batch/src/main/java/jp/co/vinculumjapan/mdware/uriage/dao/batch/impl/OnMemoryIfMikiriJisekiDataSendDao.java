...
/**
 *  <P>タイトル: OnMemoryIfMikiriJisekiDataSendDao クラス</p>
 *  <P>説明: URIB061080 見切実績データFTP送信処理</p>
 *  <P>著作権: Copyright (c) 2009</p>
 *  <P>会社名: Vinculum Japan Corporation</P>
 *  @author A.Shinsaka
 *  @version 1.0 
 */
public class OnMemoryIfMikiriJisekiDataSendDao implements DaoIf {
    ...
    // 見切実績データ
    private static final String FILE_DT_MIKIRI_JISEKI = "IF_DT_MIKIRI_JISEKI.csv";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        // ログ出力
        invoker.infoLog(strUserID + "　：　見切実績データFTP送信処理を開始します。");
        
        // 見切実績データをFTP送信
        sendFileToFtp(invoker, FILE_DT_MIKIRI_JISEKI, PATH_KIKAN_RECV_ONMEMO);

        // ログ出力
        invoker.infoLog(strUserID + "　：　見切実績データFTP送信処理を終了します。");
    ...
    public static void main(String[] arg) {
        try {
            DaoIf dao = new OnMemoryIfMikiriJisekiDataSendDao();
