...
/**
 * <p>タイトル: VatInvoiceRegistDao クラス</p>
 * <p>説明:時間帯客数集計</p>
 ...
 * @see なし
 */
public class JikantaiKyakusuSyukeiDao implements DaoIf {

    // バッチ処理名
    private static final String BATCH_NAME = "時間帯客数集計";  
    String userLocal = ResorceUtil.getInstance().getPropertie("USER_LOCAL");
    
    // バッチID
    private static final String BATCH_ID = "URIB013350";
    
    // システムコントロールよりバッチ日付取得
    private static final String BATCH_DT = FiResorceUtility.getBatchDt();
    
    /** 削除SQL */
    private static final String DEL_SQL = "TRUNCATE TABLE DT_JIKANTAI_KYAKUSU_SYUKEI";
    ...
    public void executeDataAccess(DaoInvokerIf invoker) throws Exception {
        ...
        try {
            ...
            //時間帯客数集計
            preparedStatementExIns = invoker.getDataBase().prepareStatement(getJikantaiKyakusuSyukeiDaoSql());
            ...
            // ログ出力
            invoker.infoLog(strUserID + "　：　" + insertCount + "件の時間帯客数集計データを追加しました。");
     ...
     * @return 時間帯客数集計
     */
    private String getJikantaiKyakusuSyukeiDaoSql( ) {
        StringBuilder sql = new StringBuilder();
   
        sql.append("INSERT /*+ APPEND */ INTO DT_JIKANTAI_KYAKUSU_SYUKEI( ");
        sql.append("     TENPO_CD ");
