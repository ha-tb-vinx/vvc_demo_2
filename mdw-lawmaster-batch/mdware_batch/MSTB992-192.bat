...
REM ----------------------------------------------------------------------------
REM (1)COPY-FROM-DIR 
SET SND_FROM_DIR=E:\mdware_law\datas\MKV\POS\q5\mdware\download_all\D\

REM (2)COPY-FROM-FILE-NAME
SET INFILENAME=D*

REM (3)COPY-TO-DIR 
mkdir E:\mdware_law\datas\MKV\POS\q5\mdware\download_all\D\backup\%BKUPDIR%
SET SND_TO_DIR=E:\mdware_law\datas\MKV\POS\q5\mdware\download_all\D\backup\%BKUPDIR%\
...
echo [Edrive BKUP DIV FILE] >>%LOG_DIR%%LOG_FILE%
