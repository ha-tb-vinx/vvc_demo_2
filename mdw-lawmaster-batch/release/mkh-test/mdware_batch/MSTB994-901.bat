...
dir /a-d /b E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_sti\%BKUP_DAY_STI% >>%LOG_DIR%%LOG_FILE%
rd /s /q E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_sti\%BKUP_DAY_STI%
