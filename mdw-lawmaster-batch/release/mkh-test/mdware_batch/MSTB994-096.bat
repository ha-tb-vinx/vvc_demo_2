...
REM (3)COPY-TO-DIR 
SET SND_TO_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_sti\backup\%BKUPDIR%\%BKUP_DAY_STI%
...
mkdir E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_sti\backup\%BKUPDIR%\%BKUP_DAY_STI%
