...
REM ----------------------------------------------------------------------------
REM (1)COPY-FROM-DIR 
SET SND_FROM_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_sti\%BKUP_DAY_STI%

REM (3)COPY-TO-DIR 
SET SND_TO_DIR=H:\POS-HongKong\q5\mdware\download_ini\%BKUP_DAY_STI%
...
mkdir H:\POS-HongKong\q5\mdware\download_ini\%BKUP_DAY_STI%
