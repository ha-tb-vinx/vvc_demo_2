...
REM ----------------------------------------------------------------------------
REM (1)COPY-FROM-DIR 
SET SND_FROM_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\C\

REM (2)COPY-FROM-FILE-NAME
SET INFILENAME=C*

REM (3)COPY-TO-DIR 
mkdir E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\C\backup\%BKUPDIR%
SET SND_TO_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\C\backup\%BKUPDIR%\
