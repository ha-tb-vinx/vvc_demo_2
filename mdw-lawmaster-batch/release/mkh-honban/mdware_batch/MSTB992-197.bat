...
REM ----------------------------------------------------------------------------
REM (1)COPY-FROM-DIR 
SET SND_FROM_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\K\

REM (2)COPY-FROM-FILE-NAME
SET INFILENAME=K*

REM (3)COPY-TO-DIR 
mkdir E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\K\backup\%BKUPDIR%
SET SND_TO_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download_all\K\backup\%BKUPDIR%\
...
echo [Edrive BKUP Discount type] >>%LOG_DIR%%LOG_FILE%
