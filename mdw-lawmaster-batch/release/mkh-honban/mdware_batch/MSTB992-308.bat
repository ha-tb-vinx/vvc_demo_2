...
SET INFILENAME=Q*_noncompleted

REM (3)COPY-TO-DIR 
SET SND_TO_DIR=H:\POS-HongKong\q5\mdware\download\Q\
...
echo [COPY VAT-NUMBER FILE] >>%LOG_DIR%%LOG_FILE%
