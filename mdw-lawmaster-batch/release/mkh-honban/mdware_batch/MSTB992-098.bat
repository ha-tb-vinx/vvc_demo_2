...
REM (3)COPY-TO-DIR 
mkdir E:\mdware_mkh\datas\MKH\POS\q5\mdware\download\L\backup\%BKUPDIR%
SET SND_TO_DIR=E:\mdware_mkh\datas\MKH\POS\q5\mdware\download\L\backup\%BKUPDIR%\
