...
public class DtNohinBean
{
	...
	public static final int TEI_FG_MAX_LENGTH = 1;
	public static final int TEISEI_RUYU_KB_MAX_LENGTH = 1;
	...
	public static final int KAKUTEI_FG_MAX_LENGTH = 1;
	public static final int KAKUTEI_USER_ID_MAX_LENGTH = 20;
	public static final int KAKUTEI_TS_MAX_LENGTH = 14;
	public static final int KEIJO_DT_MAX_LENGTH = 8;
	public static final int KEIJO_MAKE_FG_MAX_LENGTH = 1;
	public static final int KEIJO_MAKE_DT_MAX_LENGTH = 8;
	public static final int JURYO_MAKE_FG_MAX_LENGTH = 1;
	public static final int JURYO_MAKE_DT_MAX_LENGTH = 8;
	public static final int NOHIN_ASN_MAKE_FG_MAX_LENGTH = 1;
	public static final int NOHIN_ASN_MAKE_DT_MAX_LENGTH = 8;
	...
	private String tei_fg = null;
	private String teisei_ruyu_kb = null;
	...
	private long nohin_list_qt = 0;
	private String haisinsaki_cd = null;
	private String hojin_cd = null;
	private String hojin_na = null;
	private String kakutei_fg = null;
	private String kakutei_user_id = null;
	private String kakutei_ts = null;
	private String keijo_dt = null;
	private String keijo_make_fg = null;
	private String keijo_make_dt = null;
	private String juryo_make_fg = null;
	private String juryo_make_dt = null;
	private String nohin_asn_make_fg = null;
	private String nohin_asn_make_dt = null;
	...
	/**
	 * DtNohinBeanを１件のみ抽出したい時に使用する
	 */
	public static DtNohinBean getDtNohinBean(DataHolder dataHolder)
	{
		DtNohinBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new DtNohinDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (DtNohinBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	// tei_fgに対するセッターとゲッターの集合
	public boolean setTeiFg(String tei_fg)
	{
		this.tei_fg = tei_fg;
		return true;
	}
	public String getTeiFg()
	{
		return cutString(this.tei_fg,TEI_FG_MAX_LENGTH);
	}
	public String getTeiFgString()
	{
		return "'" + cutString(this.tei_fg,TEI_FG_MAX_LENGTH) + "'";
	}
	public String getTeiFgHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.tei_fg,TEI_FG_MAX_LENGTH));
	}


	// teisei_ruyu_kbに対するセッターとゲッターの集合
	public boolean setTeiseiRuyuKb(String teisei_ruyu_kb)
	{
		this.teisei_ruyu_kb = teisei_ruyu_kb;
		return true;
	}
	public String getTeiseiRuyuKb()
	{
		return cutString(this.teisei_ruyu_kb,TEISEI_RUYU_KB_MAX_LENGTH);
	}
	public String getTeiseiRuyuKbString()
	{
		return "'" + cutString(this.teisei_ruyu_kb,TEISEI_RUYU_KB_MAX_LENGTH) + "'";
	}
	public String getTeiseiRuyuKbHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.teisei_ruyu_kb,TEISEI_RUYU_KB_MAX_LENGTH));
	}
	...
	// nohin_list_qtに対するセッターとゲッターの集合
	public boolean setNohinListQt(String nohin_list_qt)
	{
		try
		{
			this.nohin_list_qt = Long.parseLong(nohin_list_qt);
		}
		catch(Exception e)
		{
			return false;
	...
	public boolean setNohinListQt(long nohin_list_qt)
	{
		this.nohin_list_qt = nohin_list_qt;
		return true;
	}
	public long getNohinListQt()
	{
		return this.nohin_list_qt;
	}
	public String getNohinListQtString()
	{
		return Long.toString(this.nohin_list_qt);
	}
	...
	// kakutei_fgに対するセッターとゲッターの集合
	public boolean setKakuteiFg(String kakutei_fg)
	{
		this.kakutei_fg = kakutei_fg;
		return true;
	}
	public String getKakuteiFg()
	{
		return cutString(this.kakutei_fg,KAKUTEI_FG_MAX_LENGTH);
	}
	public String getKakuteiFgString()
	{
		return "'" + cutString(this.kakutei_fg,KAKUTEI_FG_MAX_LENGTH) + "'";
	}
	public String getKakuteiFgHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.kakutei_fg,KAKUTEI_FG_MAX_LENGTH));
	}


	// kakutei_user_idに対するセッターとゲッターの集合
	public boolean setKakuteiUserId(String kakutei_user_id)
	{
		this.kakutei_user_id = kakutei_user_id;
		return true;
	}
	public String getKakuteiUserId()
	{
		return cutString(this.kakutei_user_id,KAKUTEI_USER_ID_MAX_LENGTH);
	}
	public String getKakuteiUserIdString()
	{
		return "'" + cutString(this.kakutei_user_id,KAKUTEI_USER_ID_MAX_LENGTH) + "'";
	}
	public String getKakuteiUserIdHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.kakutei_user_id,KAKUTEI_USER_ID_MAX_LENGTH));
	}


	// kakutei_tsに対するセッターとゲッターの集合
	public boolean setKakuteiTs(String kakutei_ts)
	{
		this.kakutei_ts = kakutei_ts;
		return true;
	}
	public String getKakuteiTs()
	{
		return cutString(this.kakutei_ts,KAKUTEI_TS_MAX_LENGTH);
	}
	public String getKakuteiTsString()
	{
		return "'" + cutString(this.kakutei_ts,KAKUTEI_TS_MAX_LENGTH) + "'";
	}
	public String getKakuteiTsHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.kakutei_ts,KAKUTEI_TS_MAX_LENGTH));
	}


	// keijo_dtに対するセッターとゲッターの集合
	public boolean setKeijoDt(String keijo_dt)
	{
		this.keijo_dt = keijo_dt;
		return true;
	}
	public String getKeijoDt()
	{
		return cutString(this.keijo_dt,KEIJO_DT_MAX_LENGTH);
	}
	public String getKeijoDtString()
	{
		return "'" + cutString(this.keijo_dt,KEIJO_DT_MAX_LENGTH) + "'";
	}
	public String getKeijoDtHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.keijo_dt,KEIJO_DT_MAX_LENGTH));
	}


	// keijo_make_fgに対するセッターとゲッターの集合
	public boolean setKeijoMakeFg(String keijo_make_fg)
	{
		this.keijo_make_fg = keijo_make_fg;
		return true;
	}
	public String getKeijoMakeFg()
	{
		return cutString(this.keijo_make_fg,KEIJO_MAKE_FG_MAX_LENGTH);
	}
	public String getKeijoMakeFgString()
	{
		return "'" + cutString(this.keijo_make_fg,KEIJO_MAKE_FG_MAX_LENGTH) + "'";
	}
	public String getKeijoMakeFgHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.keijo_make_fg,KEIJO_MAKE_FG_MAX_LENGTH));
	}


	// keijo_make_dtに対するセッターとゲッターの集合
	public boolean setKeijoMakeDt(String keijo_make_dt)
	{
		this.keijo_make_dt = keijo_make_dt;
		return true;
	}
	public String getKeijoMakeDt()
	{
		return cutString(this.keijo_make_dt,KEIJO_MAKE_DT_MAX_LENGTH);
	}
	public String getKeijoMakeDtString()
	{
		return "'" + cutString(this.keijo_make_dt,KEIJO_MAKE_DT_MAX_LENGTH) + "'";
	}
	public String getKeijoMakeDtHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.keijo_make_dt,KEIJO_MAKE_DT_MAX_LENGTH));
	}


	// juryo_make_fgに対するセッターとゲッターの集合
	public boolean setJuryoMakeFg(String juryo_make_fg)
	{
		this.juryo_make_fg = juryo_make_fg;
		return true;
	}
	public String getJuryoMakeFg()
	{
		return cutString(this.juryo_make_fg,JURYO_MAKE_FG_MAX_LENGTH);
	}
	public String getJuryoMakeFgString()
	{
		return "'" + cutString(this.juryo_make_fg,JURYO_MAKE_FG_MAX_LENGTH) + "'";
	}
	public String getJuryoMakeFgHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.juryo_make_fg,JURYO_MAKE_FG_MAX_LENGTH));
	}


	// juryo_make_dtに対するセッターとゲッターの集合
	public boolean setJuryoMakeDt(String juryo_make_dt)
	{
		this.juryo_make_dt = juryo_make_dt;
		return true;
	}
	public String getJuryoMakeDt()
	{
		return cutString(this.juryo_make_dt,JURYO_MAKE_DT_MAX_LENGTH);
	}
	public String getJuryoMakeDtString()
	{
		return "'" + cutString(this.juryo_make_dt,JURYO_MAKE_DT_MAX_LENGTH) + "'";
	}
	public String getJuryoMakeDtHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.juryo_make_dt,JURYO_MAKE_DT_MAX_LENGTH));
	}


	// nohin_asn_make_fgに対するセッターとゲッターの集合
	public boolean setNohinAsnMakeFg(String nohin_asn_make_fg)
	{
		this.nohin_asn_make_fg = nohin_asn_make_fg;
		return true;
	}
	public String getNohinAsnMakeFg()
	{
		return cutString(this.nohin_asn_make_fg,NOHIN_ASN_MAKE_FG_MAX_LENGTH);
	}
	public String getNohinAsnMakeFgString()
	{
		return "'" + cutString(this.nohin_asn_make_fg,NOHIN_ASN_MAKE_FG_MAX_LENGTH) + "'";
	}
	public String getNohinAsnMakeFgHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.nohin_asn_make_fg,NOHIN_ASN_MAKE_FG_MAX_LENGTH));
	}


	// nohin_asn_make_dtに対するセッターとゲッターの集合
	public boolean setNohinAsnMakeDt(String nohin_asn_make_dt)
	{
		this.nohin_asn_make_dt = nohin_asn_make_dt;
		return true;
	}
	public String getNohinAsnMakeDt()
	{
		return cutString(this.nohin_asn_make_dt,NOHIN_ASN_MAKE_DT_MAX_LENGTH);
	}
	public String getNohinAsnMakeDtString()
	{
		return "'" + cutString(this.nohin_asn_make_dt,NOHIN_ASN_MAKE_DT_MAX_LENGTH) + "'";
	}
	public String getNohinAsnMakeDtHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.nohin_asn_make_dt,NOHIN_ASN_MAKE_DT_MAX_LENGTH));
	}
	...
	public String toString()
	{
		return "  data_denp_nb = " + getDataDenpNbString()
			...
			+ "  tei_fg = " + getTeiFgString()
			+ "  teisei_ruyu_kb = " + getTeiseiRuyuKbString()
			...
			+ "  nohin_list_qt = " + getNohinListQtString()
			+ "  haisinsaki_cd = " + getHaisinsakiCdString()
			+ "  hojin_cd = " + getHojinCdString()
			+ "  hojin_na = " + getHojinNaString()
			+ "  kakutei_fg = " + getKakuteiFgString()
			+ "  kakutei_user_id = " + getKakuteiUserIdString()
			+ "  kakutei_ts = " + getKakuteiTsString()
			+ "  keijo_dt = " + getKeijoDtString()
			+ "  keijo_make_fg = " + getKeijoMakeFgString()
			+ "  keijo_make_dt = " + getKeijoMakeDtString()
			+ "  juryo_make_fg = " + getJuryoMakeFgString()
			+ "  juryo_make_dt = " + getJuryoMakeDtString()
			+ "  nohin_asn_make_fg = " + getNohinAsnMakeFgString()
			+ "  nohin_asn_make_dt = " + getNohinAsnMakeDtString()
	 ...
	 * @return DtNohinBean コピー後のクラス
	 */
	public DtNohinBean createClone()
	{
		...
		bean.setTeiFg(this.tei_fg);
		bean.setTeiseiRuyuKb(this.teisei_ruyu_kb);
		...
		bean.setNohinListQt(this.nohin_list_qt);
		bean.setHaisinsakiCd(this.haisinsaki_cd);
		bean.setHojinCd(this.hojin_cd);
		bean.setHojinNa(this.hojin_na);
		bean.setKakuteiFg(this.kakutei_fg);
		bean.setKakuteiUserId(this.kakutei_user_id);
		bean.setKakuteiTs(this.kakutei_ts);
		bean.setKeijoDt(this.keijo_dt);
		bean.setKeijoMakeFg(this.keijo_make_fg);
		bean.setKeijoMakeDt(this.keijo_make_dt);
		bean.setJuryoMakeFg(this.juryo_make_fg);
		bean.setJuryoMakeDt(this.juryo_make_dt);
		bean.setNohinAsnMakeFg(this.nohin_asn_make_fg);
		bean.setNohinAsnMakeDt(this.nohin_asn_make_dt);
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof DtNohinBean ) ) return false;
