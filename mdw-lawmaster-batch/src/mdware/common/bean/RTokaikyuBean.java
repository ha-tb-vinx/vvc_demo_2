...
public class RTokaikyuBean
{
	...
	{
		//return "'" + cutString(this.tokyu_cd,TOKYU_CD_MAX_LENGTH) + "'";
	...
	{
		//return "'" + cutString(this.tokyu_na,TOKYU_NA_MAX_LENGTH) + "'";
