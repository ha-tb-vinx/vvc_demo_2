...
public class RBumonBean
{
	...
	// seisen_fg に対するセッタメソッド。
	public void setSeisenFg(String seisen_fg)
	{
		this.seisen_fg = seisen_fg;
	}
	// seisen_fg に対するゲッタメソッド。
	...
	{
		//return "'" + cutString(this.seisen_fg,SEISEN_FG_MAX_LENGTH) + "'";
		if(this.seisen_fg == null) {
			return NULL_VAL;
		}
		return "'" + cutStringForSql(this.seisen_fg,SEISEN_FG_MAX_LENGTH) + "'";
	}
