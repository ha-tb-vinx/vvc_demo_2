...
public class MaChubunruiBean
{
	...
	public static final int CHUBUNRUI_NA_MAX_LENGTH          =  40;
	public static final int CHUBUNRUI_KA_MAX_LENGTH          =  30;
	...
	private String chubunrui_na = null;
	private String chubunrui_ka = null;
	...
	// chubunrui_na に対するセッタメソッド。
	public void setChubunruiNa(String chubunrui_na)
	{
		this.chubunrui_na = chubunrui_na;
	}
	// chubunrui_na に対するゲッタメソッド。
	public String getChubunruiNa()
	{
		return cutString(this.chubunrui_na,CHUBUNRUI_NA_MAX_LENGTH);
	}
	public String getChubunruiNaString()
	{
		//return "'" + cutString(this.chubunrui_na,CHUBUNRUI_NA_MAX_LENGTH) + "'";
		if(this.chubunrui_na == null) {
			return NULL_VAL;
		}
		return "'" + cutStringForSql(this.chubunrui_na,CHUBUNRUI_NA_MAX_LENGTH) + "'";
	}

	// chubunrui_ka に対するセッタメソッド。
	public void setChubunruiKa(String chubunrui_ka)
	{
		this.chubunrui_ka = chubunrui_ka;
	}
	// chubunrui_ka に対するゲッタメソッド。
	public String getChubunruiKa()
	{
		return cutString(this.chubunrui_ka,CHUBUNRUI_KA_MAX_LENGTH);
	}
	public String getChubunruiKaString()
	{
		//return "'" + cutString(this.chubunrui_ka,CHUBUNRUI_KA_MAX_LENGTH) + "'";
		if(this.chubunrui_ka == null) {
			return NULL_VAL;
		}
		return "'" + cutStringForSql(this.chubunrui_ka,CHUBUNRUI_KA_MAX_LENGTH) + "'";
	}
	...
	public String toString() {
		...
		+ " chubunrui_na = "              + getChubunruiNaString()
		+ " chubunrui_ka = "              + getChubunruiKaString()
