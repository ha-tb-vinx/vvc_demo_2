 ...
 */
public class RKikakuDM extends DataModule
{
	...
	private synchronized int getNextSeq()
	{
		...
		{
			if( sequence < 0 )
				sequence = Integer.parseInt(super.getNextSequence("------","r_kikaku"));
			sequence++;
			retSeq = sequence;
		}
		return retSeq;
	...
	protected Object instanceBean( ResultSet rest )
		throws SQLException
	{
		RKikakuBean bean = new RKikakuBean();
	...
	public String getSelectSql( Map map )
	{
		...
		sb.append("select * from r_kikaku ");
	...
	{
		RKikakuBean bean = (RKikakuBean)beanMst;
		StringBuffer sb = new StringBuffer();
