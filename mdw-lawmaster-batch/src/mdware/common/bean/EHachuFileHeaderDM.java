 ...
 */
public class EHachuFileHeaderDM extends DataModule
{
	/**
	 * コンストラクタ
	 */
	public EHachuFileHeaderDM()
	{
		super( "rbsite_ora");
	}
	/**
		...
		throws SQLException
	{
		...
		bean.setDenpatuJyokyoFg( rest.getString("denpatu_jyokyo_fg") );
		bean.setServerFileNa( rest.getString("server_file_na") );
		bean.setFileLengthQt( rest.getString("file_length_qt") );
		bean.setHachuDataKb( rest.getString("hachu_data_kb") );
	...
	public String getSelectSql( Map map )
	{
		...
		sb.append(", ");
		sb.append("denpatu_jyokyo_fg ");
		sb.append(", ");
		sb.append("server_file_na ");
		sb.append(", ");
		sb.append("file_length_qt ");
		sb.append(", ");
		sb.append("hachu_data_kb ");
		sb.append(", ");
		...
		sb.append(", ");
		sb.append("update_ts ");
		sb.append("from e_hachu_file_header ");
		...
		// denpatu_jyokyo_fg に対するWHERE区
		if( map.get("denpatu_jyokyo_fg_bef") != null && ((String)map.get("denpatu_jyokyo_fg_bef")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg >= '" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_bef") ) + "'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_aft") != null && ((String)map.get("denpatu_jyokyo_fg_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg <= '" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_aft") ) + "'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg") != null && ((String)map.get("denpatu_jyokyo_fg")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg = '" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg") ) + "'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_like") != null && ((String)map.get("denpatu_jyokyo_fg_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg like '%" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_bef_like") != null && ((String)map.get("denpatu_jyokyo_fg_bef_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg like '%" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_bef_like") ) + "'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_aft_like") != null && ((String)map.get("denpatu_jyokyo_fg_aft_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg like '" + conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_aft_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_in") != null && ((String)map.get("denpatu_jyokyo_fg_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg in ( '" + replaceAll(conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("denpatu_jyokyo_fg_not_in") != null && ((String)map.get("denpatu_jyokyo_fg_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("denpatu_jyokyo_fg not in ( '" + replaceAll(conv.convertWhereString( (String)map.get("denpatu_jyokyo_fg_not_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		...
		// hachu_data_kb に対するWHERE区
		if( map.get("hachu_data_kb_bef") != null && ((String)map.get("hachu_data_kb_bef")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb >= '" + conv.convertWhereString( (String)map.get("hachu_data_kb_bef") ) + "'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_aft") != null && ((String)map.get("hachu_data_kb_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb <= '" + conv.convertWhereString( (String)map.get("hachu_data_kb_aft") ) + "'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb") != null && ((String)map.get("hachu_data_kb")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb = '" + conv.convertWhereString( (String)map.get("hachu_data_kb") ) + "'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_like") != null && ((String)map.get("hachu_data_kb_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb like '%" + conv.convertWhereString( (String)map.get("hachu_data_kb_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_bef_like") != null && ((String)map.get("hachu_data_kb_bef_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb like '%" + conv.convertWhereString( (String)map.get("hachu_data_kb_bef_like") ) + "'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_aft_like") != null && ((String)map.get("hachu_data_kb_aft_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb like '" + conv.convertWhereString( (String)map.get("hachu_data_kb_aft_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_in") != null && ((String)map.get("hachu_data_kb_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb in ( '" + replaceAll(conv.convertWhereString( (String)map.get("hachu_data_kb_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("hachu_data_kb_not_in") != null && ((String)map.get("hachu_data_kb_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_data_kb not in ( '" + replaceAll(conv.convertWhereString( (String)map.get("hachu_data_kb_not_in") ),",","','") + "' )");
			whereStr = andStr;
		}
	...
	public String getInsertSql( Object beanMst )
	{
		...
		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		EHachuFileHeaderBean bean = (EHachuFileHeaderBean)beanMst;
		StringBuffer sb = new StringBuffer();
		sb.append("insert into ");
		sb.append("e_hachu_file_header (");
		...
		if( bean.getDenpatuJyokyoFg() != null && bean.getDenpatuJyokyoFg().trim().length() != 0 )
		{
			sb.append(",");
			sb.append(" denpatu_jyokyo_fg");
		}
		...
		if( bean.getHachuDataKb() != null && bean.getHachuDataKb().trim().length() != 0 )
		{
			sb.append(",");
			sb.append(" hachu_data_kb");
		}
		...
		{
			sb.append(",");
			sb.append("'" + conv.convertString( bean.getDenpatuJyokyoFg() ) + "'");
		}
		if( bean.getServerFileNa() != null && bean.getServerFileNa().trim().length() != 0 )
		{
			sb.append(",");
		...
		{
			sb.append(",");
			sb.append("'" + conv.convertString( bean.getHachuDataKb() ) + "'");
		}
		if( bean.getRiyoUserId() != null && bean.getRiyoUserId().trim().length() != 0 )
		{
			sb.append(",");
	...
	public String getUpdateSql( Object beanMst )
	{
		...
		StringBuffer sb = new StringBuffer();
		sb.append("update ");
		sb.append("e_hachu_file_header set ");
		befKanma = true;
		sb.append(" jca_control_nb = ");
		sb.append( bean.getJcaControlNbString());
		if( bean.getSyoriJyokyoFg() != null && bean.getSyoriJyokyoFg().trim().length() != 0 )
	...
	public String getDeleteSql( Object beanMst )
	{
		...
		sb.append("e_hachu_file_header where ");
		sb.append(" file_head_nb = ");
		sb.append("'" + conv.convertWhereString( bean.getFileHeadNb() ) + "'");
		return sb.toString();
	}
