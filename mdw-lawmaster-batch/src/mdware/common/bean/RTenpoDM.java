 ...
 * @version X.X (Create time: 2006/11/8 21:52:13)
 */
public class RTenpoDM extends DataModule
{
	/**
	 * コンストラクタ
	 */
	...
	protected Object instanceBean( ResultSet rest )
		throws SQLException
	{
		RTenpoBean bean = new RTenpoBean();
	...
	public String getSelectSql( Map map )
	{
		...
		if( map.get("tenpo_cd_select_in") != null && ((String)map.get("tenpo_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_cd in ( " +  (String)map.get("tenpo_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpo_cd_select_not_in") != null && ((String)map.get("tenpo_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_cd not in ( " +  (String)map.get("tenpo_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hojin_cd_select_in") != null && ((String)map.get("hojin_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hojin_cd in ( " +  (String)map.get("hojin_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hojin_cd_select_not_in") != null && ((String)map.get("hojin_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hojin_cd not in ( " +  (String)map.get("hojin_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tenpokaiso_tiiki_cd_select_in") != null && ((String)map.get("tenpokaiso_tiiki_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_tiiki_cd in ( " +  (String)map.get("tenpokaiso_tiiki_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpokaiso_tiiki_cd_select_not_in") != null && ((String)map.get("tenpokaiso_tiiki_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_tiiki_cd not in ( " +  (String)map.get("tenpokaiso_tiiki_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tenpokaiso_area_cd_select_in") != null && ((String)map.get("tenpokaiso_area_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_area_cd in ( " +  (String)map.get("tenpokaiso_area_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpokaiso_area_cd_select_not_in") != null && ((String)map.get("tenpokaiso_area_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_area_cd not in ( " +  (String)map.get("tenpokaiso_area_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tenpokaiso_block_cd_select_in") != null && ((String)map.get("tenpokaiso_block_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_block_cd in ( " +  (String)map.get("tenpokaiso_block_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpokaiso_block_cd_select_not_in") != null && ((String)map.get("tenpokaiso_block_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpokaiso_block_cd not in ( " +  (String)map.get("tenpokaiso_block_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("kanji_na_select_in") != null && ((String)map.get("kanji_na_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kanji_na in ( " +  (String)map.get("kanji_na_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("kanji_na_select_not_in") != null && ((String)map.get("kanji_na_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kanji_na not in ( " +  (String)map.get("kanji_na_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("kana_na_select_in") != null && ((String)map.get("kana_na_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kana_na in ( " +  (String)map.get("kana_na_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("kana_na_select_not_in") != null && ((String)map.get("kana_na_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kana_na not in ( " +  (String)map.get("kana_na_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("kanji_rn_select_in") != null && ((String)map.get("kanji_rn_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kanji_rn in ( " +  (String)map.get("kanji_rn_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("kanji_rn_select_not_in") != null && ((String)map.get("kanji_rn_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kanji_rn not in ( " +  (String)map.get("kanji_rn_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("kana_rn_select_in") != null && ((String)map.get("kana_rn_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kana_rn in ( " +  (String)map.get("kana_rn_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("kana_rn_select_not_in") != null && ((String)map.get("kana_rn_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kana_rn not in ( " +  (String)map.get("kana_rn_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tenpo_type_kb_select_in") != null && ((String)map.get("tenpo_type_kb_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_type_kb in ( " +  (String)map.get("tenpo_type_kb_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpo_type_kb_select_not_in") != null && ((String)map.get("tenpo_type_kb_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_type_kb not in ( " +  (String)map.get("tenpo_type_kb_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tenpo_kb_select_in") != null && ((String)map.get("tenpo_kb_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_kb in ( " +  (String)map.get("tenpo_kb_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tenpo_kb_select_not_in") != null && ((String)map.get("tenpo_kb_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tenpo_kb not in ( " +  (String)map.get("tenpo_kb_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("kaiten_dt_select_in") != null && ((String)map.get("kaiten_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kaiten_dt in ( " +  (String)map.get("kaiten_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("kaiten_dt_select_not_in") != null && ((String)map.get("kaiten_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("kaiten_dt not in ( " +  (String)map.get("kaiten_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("heiten_dt_select_in") != null && ((String)map.get("heiten_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("heiten_dt in ( " +  (String)map.get("heiten_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("heiten_dt_select_not_in") != null && ((String)map.get("heiten_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("heiten_dt not in ( " +  (String)map.get("heiten_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("address_kanji_na_select_in") != null && ((String)map.get("address_kanji_na_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_kanji_na in ( " +  (String)map.get("address_kanji_na_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("address_kanji_na_select_not_in") != null && ((String)map.get("address_kanji_na_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_kanji_na not in ( " +  (String)map.get("address_kanji_na_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("address_kana_na_select_in") != null && ((String)map.get("address_kana_na_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_kana_na in ( " +  (String)map.get("address_kana_na_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("address_kana_na_select_not_in") != null && ((String)map.get("address_kana_na_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_kana_na not in ( " +  (String)map.get("address_kana_na_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("address_3_na_select_in") != null && ((String)map.get("address_3_na_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_3_na in ( " +  (String)map.get("address_3_na_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("address_3_na_select_not_in") != null && ((String)map.get("address_3_na_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("address_3_na not in ( " +  (String)map.get("address_3_na_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("yubin_cd_select_in") != null && ((String)map.get("yubin_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("yubin_cd in ( " +  (String)map.get("yubin_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("yubin_cd_select_not_in") != null && ((String)map.get("yubin_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("yubin_cd not in ( " +  (String)map.get("yubin_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("tel_cd_select_in") != null && ((String)map.get("tel_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tel_cd in ( " +  (String)map.get("tel_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("tel_cd_select_not_in") != null && ((String)map.get("tel_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("tel_cd not in ( " +  (String)map.get("tel_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("fax_cd_select_in") != null && ((String)map.get("fax_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("fax_cd in ( " +  (String)map.get("fax_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("fax_cd_select_not_in") != null && ((String)map.get("fax_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("fax_cd not in ( " +  (String)map.get("fax_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hachu_st_dt_select_in") != null && ((String)map.get("hachu_st_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_st_dt in ( " +  (String)map.get("hachu_st_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hachu_st_dt_select_not_in") != null && ((String)map.get("hachu_st_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_st_dt not in ( " +  (String)map.get("hachu_st_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hachu_ed_dt_select_in") != null && ((String)map.get("hachu_ed_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_ed_dt in ( " +  (String)map.get("hachu_ed_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hachu_ed_dt_select_not_in") != null && ((String)map.get("hachu_ed_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hachu_ed_dt not in ( " +  (String)map.get("hachu_ed_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_nehuda_dt_select_in") != null && ((String)map.get("sndst_nehuda_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_nehuda_dt in ( " +  (String)map.get("sndst_nehuda_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_nehuda_dt_select_not_in") != null && ((String)map.get("sndst_nehuda_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_nehuda_dt not in ( " +  (String)map.get("sndst_nehuda_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_price_dt_select_in") != null && ((String)map.get("sndst_price_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_price_dt in ( " +  (String)map.get("sndst_price_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_price_dt_select_not_in") != null && ((String)map.get("sndst_price_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_price_dt not in ( " +  (String)map.get("sndst_price_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_tag_dt_select_in") != null && ((String)map.get("sndst_tag_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_tag_dt in ( " +  (String)map.get("sndst_tag_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_tag_dt_select_not_in") != null && ((String)map.get("sndst_tag_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_tag_dt not in ( " +  (String)map.get("sndst_tag_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_plu_dt_select_in") != null && ((String)map.get("sndst_plu_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_plu_dt in ( " +  (String)map.get("sndst_plu_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_plu_dt_select_not_in") != null && ((String)map.get("sndst_plu_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_plu_dt not in ( " +  (String)map.get("sndst_plu_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_pop_dt_select_in") != null && ((String)map.get("sndst_pop_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_pop_dt in ( " +  (String)map.get("sndst_pop_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_pop_dt_select_not_in") != null && ((String)map.get("sndst_pop_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_pop_dt not in ( " +  (String)map.get("sndst_pop_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("sndst_keiryoki_dt_select_in") != null && ((String)map.get("sndst_keiryoki_dt_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_keiryoki_dt in ( " +  (String)map.get("sndst_keiryoki_dt_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("sndst_keiryoki_dt_select_not_in") != null && ((String)map.get("sndst_keiryoki_dt_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("sndst_keiryoki_dt not in ( " +  (String)map.get("sndst_keiryoki_dt_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hanku1_keiryoki_type_select_in") != null && ((String)map.get("hanku1_keiryoki_type_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku1_keiryoki_type in ( " +  (String)map.get("hanku1_keiryoki_type_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hanku1_keiryoki_type_select_not_in") != null && ((String)map.get("hanku1_keiryoki_type_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku1_keiryoki_type not in ( " +  (String)map.get("hanku1_keiryoki_type_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hanku2_keiryoki_type_select_in") != null && ((String)map.get("hanku2_keiryoki_type_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku2_keiryoki_type in ( " +  (String)map.get("hanku2_keiryoki_type_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hanku2_keiryoki_type_select_not_in") != null && ((String)map.get("hanku2_keiryoki_type_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku2_keiryoki_type not in ( " +  (String)map.get("hanku2_keiryoki_type_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hanku3_keiryoki_type_select_in") != null && ((String)map.get("hanku3_keiryoki_type_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku3_keiryoki_type in ( " +  (String)map.get("hanku3_keiryoki_type_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hanku3_keiryoki_type_select_not_in") != null && ((String)map.get("hanku3_keiryoki_type_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku3_keiryoki_type not in ( " +  (String)map.get("hanku3_keiryoki_type_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("hanku4_keiryoki_type_select_in") != null && ((String)map.get("hanku4_keiryoki_type_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku4_keiryoki_type in ( " +  (String)map.get("hanku4_keiryoki_type_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("hanku4_keiryoki_type_select_not_in") != null && ((String)map.get("hanku4_keiryoki_type_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("hanku4_keiryoki_type not in ( " +  (String)map.get("hanku4_keiryoki_type_select_not_in") + " )");
			whereStr = andStr;
		}


		// pos_kb に対するWHERE区
		if( map.get("pos_kb_bef") != null && ((String)map.get("pos_kb_bef")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb >= '" + conv.convertWhereString( (String)map.get("pos_kb_bef") ) + "'");
			whereStr = andStr;
		}
		if( map.get("pos_kb_aft") != null && ((String)map.get("pos_kb_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb <= '" + conv.convertWhereString( (String)map.get("pos_kb_aft") ) + "'");
			whereStr = andStr;
		}
		if( map.get("pos_kb") != null && ((String)map.get("pos_kb")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb = '" + conv.convertWhereString( (String)map.get("pos_kb") ) + "'");
			whereStr = andStr;
		}
		if( map.get("pos_kb_like") != null && ((String)map.get("pos_kb_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb like '%" + conv.convertWhereString( (String)map.get("pos_kb_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("pos_kb_bef_like") != null && ((String)map.get("pos_kb_bef_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb like '%" + conv.convertWhereString( (String)map.get("pos_kb_bef_like") ) + "'");
			whereStr = andStr;
		}
		if( map.get("pos_kb_aft_like") != null && ((String)map.get("pos_kb_aft_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb like '" + conv.convertWhereString( (String)map.get("pos_kb_aft_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("pos_kb_in") != null && ((String)map.get("pos_kb_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb in ( '" + replaceAll(conv.convertWhereString( (String)map.get("pos_kb_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("pos_kb_not_in") != null && ((String)map.get("pos_kb_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb not in ( '" + replaceAll(conv.convertWhereString( (String)map.get("pos_kb_not_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("pos_kb_select_in") != null && ((String)map.get("pos_kb_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb in ( " +  (String)map.get("pos_kb_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("pos_kb_select_not_in") != null && ((String)map.get("pos_kb_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("pos_kb not in ( " +  (String)map.get("pos_kb_select_not_in") + " )");
			whereStr = andStr;
		}


		// boten_cd に対するWHERE区
		if( map.get("boten_cd_bef") != null && ((String)map.get("boten_cd_bef")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd >= '" + conv.convertWhereString( (String)map.get("boten_cd_bef") ) + "'");
			whereStr = andStr;
		}
		if( map.get("boten_cd_aft") != null && ((String)map.get("boten_cd_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd <= '" + conv.convertWhereString( (String)map.get("boten_cd_aft") ) + "'");
			whereStr = andStr;
		}
		if( map.get("boten_cd") != null && ((String)map.get("boten_cd")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd = '" + conv.convertWhereString( (String)map.get("boten_cd") ) + "'");
			whereStr = andStr;
		}
		if( map.get("boten_cd_like") != null && ((String)map.get("boten_cd_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd like '%" + conv.convertWhereString( (String)map.get("boten_cd_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("boten_cd_bef_like") != null && ((String)map.get("boten_cd_bef_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd like '%" + conv.convertWhereString( (String)map.get("boten_cd_bef_like") ) + "'");
			whereStr = andStr;
		}
		if( map.get("boten_cd_aft_like") != null && ((String)map.get("boten_cd_aft_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd like '" + conv.convertWhereString( (String)map.get("boten_cd_aft_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("boten_cd_in") != null && ((String)map.get("boten_cd_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd in ( '" + replaceAll(conv.convertWhereString( (String)map.get("boten_cd_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("boten_cd_not_in") != null && ((String)map.get("boten_cd_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd not in ( '" + replaceAll(conv.convertWhereString( (String)map.get("boten_cd_not_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("boten_cd_select_in") != null && ((String)map.get("boten_cd_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd in ( " +  (String)map.get("boten_cd_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("boten_cd_select_not_in") != null && ((String)map.get("boten_cd_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("boten_cd not in ( " +  (String)map.get("boten_cd_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("gyotai_kb_select_in") != null && ((String)map.get("gyotai_kb_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("gyotai_kb in ( " +  (String)map.get("gyotai_kb_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("gyotai_kb_select_not_in") != null && ((String)map.get("gyotai_kb_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("gyotai_kb not in ( " +  (String)map.get("gyotai_kb_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("insert_ts_select_in") != null && ((String)map.get("insert_ts_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("insert_ts in ( " +  (String)map.get("insert_ts_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("insert_ts_select_not_in") != null && ((String)map.get("insert_ts_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("insert_ts not in ( " +  (String)map.get("insert_ts_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("insert_user_id_select_in") != null && ((String)map.get("insert_user_id_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("insert_user_id in ( " +  (String)map.get("insert_user_id_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("insert_user_id_select_not_in") != null && ((String)map.get("insert_user_id_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("insert_user_id not in ( " +  (String)map.get("insert_user_id_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("update_ts_select_in") != null && ((String)map.get("update_ts_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("update_ts in ( " +  (String)map.get("update_ts_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("update_ts_select_not_in") != null && ((String)map.get("update_ts_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("update_ts not in ( " +  (String)map.get("update_ts_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("update_user_id_select_in") != null && ((String)map.get("update_user_id_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("update_user_id in ( " +  (String)map.get("update_user_id_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("update_user_id_select_not_in") != null && ((String)map.get("update_user_id_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("update_user_id not in ( " +  (String)map.get("update_user_id_select_not_in") + " )");
			whereStr = andStr;
		}
		...
		if( map.get("delete_fg_select_in") != null && ((String)map.get("delete_fg_select_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("delete_fg in ( " +  (String)map.get("delete_fg_select_in")  + " )");
			whereStr = andStr;
		}
		if( map.get("delete_fg_select_not_in") != null && ((String)map.get("delete_fg_select_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("delete_fg not in ( " +  (String)map.get("delete_fg_select_not_in") + " )");
			whereStr = andStr;
		}
		sb.append(" order by ");
		sb.append("tenpo_cd");
	...
	public String getInsertSql( Object beanMst )
	{
		...
		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		RTenpoBean bean = (RTenpoBean)beanMst;
		StringBuffer sb = new StringBuffer();
