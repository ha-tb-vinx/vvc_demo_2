 ...
 * @version 1.0
 */
public class EUploadFileHeaderDM extends DataModule
{
	...
	private synchronized int getNextSeq()
	{
		...
		{
			if( sequence < 0 )
				sequence = Integer.parseInt(super.getNextSequence("------","e_upload_file_header"));
			sequence++;
			retSeq = sequence;
		}
		return retSeq;
	...
	protected Object instanceBean( ResultSet rest )
		throws SQLException
	{
		EUploadFileHeaderBean bean = new EUploadFileHeaderBean();
	...
	public String getSelectSql( Map map )
	{
		...
		sb.append(" from e_upload_file_header ");
...
// 20030226 @rep end
	...
	{
		EUploadFileHeaderBean bean = (EUploadFileHeaderBean)beanMst;
		StringBuffer sb = new StringBuffer();
		sb.append("insert into ");
		sb.append("e_upload_file_header (");
		sb.append(" file_head_nb");
		sb.append(",");
		sb.append(" jca_control_nb");
		sb.append(",");
	...
	public String getUpdateSql( Object beanMst )
	{
		...
		StringBuffer sb = new StringBuffer();
		sb.append("update ");
		sb.append("e_upload_file_header set ");
		sb.append(" jca_control_nb = ");
		sb.append( bean.getJcaControlNbString());
		sb.append(",");
		sb.append(" syori_jyokyo_fg = ");
...
// 20030226 @rep end
	...
	public String getDeleteSql( Object beanMst )
	{
		...
		sb.append("e_upload_file_header where ");
		sb.append(" file_head_nb = ");
		sb.append( bean.getFileHeadNbString());
		return sb.toString();
	}
