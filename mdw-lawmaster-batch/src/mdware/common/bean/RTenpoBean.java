 ...
 * @version 1.0
 */
public class RTenpoBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	public static final int TENPO_CD_MAX_LENGTH = 6;
	public static final int HOJIN_CD_MAX_LENGTH = 4;
	public static final int TENPOKAISO_TIIKI_CD_MAX_LENGTH = 6;
	public static final int TENPOKAISO_AREA_CD_MAX_LENGTH = 6;
	public static final int TENPOKAISO_BLOCK_CD_MAX_LENGTH = 6;
	public static final int KANJI_NA_MAX_LENGTH = 80;
	public static final int KANA_NA_MAX_LENGTH = 80;
	public static final int KANJI_RN_MAX_LENGTH = 20;
	public static final int KANA_RN_MAX_LENGTH = 20;
	...
	public static final int ADDRESS_KANJI_NA_MAX_LENGTH = 120;
	public static final int ADDRESS_KANA_NA_MAX_LENGTH = 60;
	public static final int ADDRESS_3_NA_MAX_LENGTH = 32;
	...
	public static final int SNDST_NEHUDA_DT_MAX_LENGTH = 8;
	public static final int SNDST_PRICE_DT_MAX_LENGTH = 8;
	public static final int SNDST_TAG_DT_MAX_LENGTH = 8;
	public static final int SNDST_PLU_DT_MAX_LENGTH = 8;
	public static final int SNDST_POP_DT_MAX_LENGTH = 8;
	public static final int SNDST_KEIRYOKI_DT_MAX_LENGTH = 8;
	public static final int HANKU1_KEIRYOKI_TYPE_MAX_LENGTH = 1;
	public static final int HANKU2_KEIRYOKI_TYPE_MAX_LENGTH = 1;
	public static final int HANKU3_KEIRYOKI_TYPE_MAX_LENGTH = 1;
	public static final int HANKU4_KEIRYOKI_TYPE_MAX_LENGTH = 1;
	public static final int POS_KB_MAX_LENGTH = 1;
	public static final int BOTEN_CD_MAX_LENGTH = 6;
	public static final int GYOTAI_KB_MAX_LENGTH = 1;
	...
	private String tenpokaiso_tiiki_cd = null;
	private String tenpokaiso_area_cd = null;
	private String tenpokaiso_block_cd = null;
	...
	private String sndst_nehuda_dt = null;
	private String sndst_price_dt = null;
	private String sndst_tag_dt = null;
	private String sndst_plu_dt = null;
	private String sndst_pop_dt = null;
	private String sndst_keiryoki_dt = null;
	private String hanku1_keiryoki_type = null;
	private String hanku2_keiryoki_type = null;
	private String hanku3_keiryoki_type = null;
	private String hanku4_keiryoki_type = null;
	private String pos_kb = null;
	private String boten_cd = null;
	 ...
	 */
	public static RTenpoBean getRTenpoBean(DataHolder dataHolder)
	{
		RTenpoBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new RTenpoDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (RTenpoBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof RTenpoBean ) ) return false;
