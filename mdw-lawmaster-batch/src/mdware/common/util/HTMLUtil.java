...
/**
 * <p>タイトル: HTMLUtil クラス</p>
 * <p>説明: HTML(JSP) 出力用のユーティリティクラスです。2006/05/01以降使用禁止</p>
 * <p>著作権: Copyright (c) 2002-2003</p>
 * <p>会社名: Vinculum Japan Corporation</p>
 * @author M.Ashizawa
 * @version 1.2  (2003.10.24) J.Kirihara cutStringCharLengthメソッドを追加。文字列を指定文字数でカットする。
 * @version 1.1  (2003.02.18) M.Ashizawa パフォーマンスチューニング。
 * @version 1.0c (2003.02.03) M.Ashizawa suffix で使われる識別子を ':' から '_' に変更。
 * @version 1.0b (2003.02.01) M.Ashizawa suffix で使われる識別子を '$' から ':' に変更。
 * @version 1.0a (2002.12.15) 初版作成
 */
