...
// 20030416 @ADD deguchi DB内フィールド型変更により end
	...
	private boolean successful = true; //作業用フラグ
	...
	{
		return "  file_head_nb = " + getFileHeadNbString()  + "  jca_control_nb = " + getJcaControlNbString()  + "  syori_jyokyo_fg = " + getSyoriJyokyoFgString()  + "  riyo_user_id = " + getRiyoUserIdString()	+ "  server_file_na = " + getServerFileNaString()  + "  client_file_na = " + getClientFileNaString()  + "  insert_ts = " + getInsertTsString()  + "  update_ts = " + getUpdateTsString() ;
	}
