...
/**
 * 
 * <p>タイトル: MSTB993041_IniErrPosSyohinBackUp.java クラス</p>
 * <p>説明　: イニシャルPLU用商品マスタエラーワーク作成</p>
 * <p>著作権: Copyright (c) 2013</p>
 * <p>会社名: VINX</p>
 * @version 1.00 (2016.10.03) nv.cuong
 *
 */
public class MSTB993041_IniErrPosSyohinBackUp {
	 ...
	 * @param dataBase
	 */
	public MSTB993041_IniErrPosSyohinBackUp(DataBase db) {
		this.db = db;
		if (db == null) {
	 ...
	 * コンストラクタ
	 */
	public MSTB993041_IniErrPosSyohinBackUp() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			// ERR_INI_PLU店別商品の登録
			writeLog(Level.INFO_INT, "イニシャルPLU用商品マスタエラーワーク作成を開始します。");
			iRec = db.executeUpdate(getErrInitPluSyohinInsertSql());
			writeLog(Level.INFO_INT, "イニシャルPLU用商品マスタエラーワーク作成を" + iRec + "件作成しました。");
			writeLog(Level.INFO_INT, "イニシャルPLU用商品マスタエラーワーク作成を終了します。");
...
/********** ＳＱＬ生成処理 **********/
	 ...
	 */
	private String getErrInitPluSyohinInsertSql() throws SQLException {
		StringBuilder sql = new StringBuilder();

		sql.append("INSERT  /*+ APPEND */ INTO DT_ERR_INI_TEC_PLU ");
		sql.append("	( ");
		sql.append("	 SEQ_NB ");
		...
		sql.append("	) ");
		sql.append("SELECT ");
		sql.append("	 SEQ_DT_ERR_INI_TEC_PLU.NEXTVAL ");
