...
/**
 *
 * <p>タイトル: MSTB993071_IniPosFileCreate.java クラス</p>
 * <p>説明　 : POS連携ファイルを、IF_INI_POS部門メンテ、IF_INI_POSデプトメンテ、<br>
 *             IF_INI_POSクラスメンテ、IF_INI_POSサブクラスメンテ、IF_INI_PLU単品メンテ、<br>
 *             IF_INI_POS支払種別メンテ、IF_INI_POS特売種別メンテからデータを取得して作成する。</p>
 * <p>著作権: Copyright (c) 2016</p>
 * <p>会社名: VINX</p>
 * @Version 1.00  (2016.10.03) VINX t.han FIVImart様対応
 * @Version 1.01  (2016.11.24) VINX nv.cuong #2839 FIVImart様対応
 * @Version 1.02  (2016.12.08) M.Akagi #3237
 * @Version 1.03  (2016.12.12) nv.cuong #3049
 * @version 1.04  (2016.12.12) #3234 nv.cuong
 * @version 1.05  (2016.12.19) #3233 nv.cuong
 * @version 1.06  (2017.01.12) T.Han #3583 FIVIMART対応
 * @version 1.07  (2017.02.09) #3765 S.Takayama
 * @version 1.08  (2017.02.16) #4004 T.Han FIVImart対応
 * @version 1.09  (2017.04.26) #4824 T.Han FIVImart対応
 * @version 1.10  (2017.05.19) #5044 M.Son FIVImart対応
 * @version 1.11  (2020.07.13) KHAI.NN #6167 MKV対応
 * @version 1.12  (2020.09.18) KHAI.NN #6227 MKV対応
 * @version 1.13  (2020.09.30) KHAI.NN #6238 MKV対応
 * @version 1.14  (2021.12.10) KHOI.ND #6401 MKH対応
 * @version 1.15  (2023.12.01) TUNG.LT #20077 MKH対応
 * @Version 1.16  (2024.01.16) DUY.HM #15277 MKH対応
 */
public class MSTB993071_IniPosFileCreate {
     ...
     * @param dataBase
     */
    public MSTB993071_IniPosFileCreate(DataBase db) {
        this.db = db;
        if (db == null) {
     ...
     * コンストラクタ
     */
    public MSTB993071_IniPosFileCreate() {
    ...
    public void execute() throws Exception {
        ...
        try {
            ...
            while (rsData.next()){
                ...
                // add 2016.11.24 #2839 nv.cuong(E)
                MSTB993071_PosFileCreateRow rowData = new MSTB993071_PosFileCreateRow(eigyoDt, tenpoCd,gyotaiKb);
                densoRecordList.add(rowData);
            }
            for (Object densoRecord : densoRecordList) {
                MSTB993071_PosFileCreateRow rowData = (MSTB993071_PosFileCreateRow) densoRecord;
                ...
                //if("3".equals(rowData.getGyotaiKb())){
            ...
            while (rsData.next()){
                ...
                eigyoDt = rsData.getString("EIGYO_DT");
                tenpoCd = rsData.getString("TENPO_CD");
                // add 2014.11.24 #2839 nv.cuong(S)
                gyotaiKb = rsData.getString("GYOTAI_KB");
                // add 2014.11.24 #2839 nv.cuong(E)
                MSTB993071_PosFileCreateRow rowData = new MSTB993071_PosFileCreateRow(eigyoDt, tenpoCd, gyotaiKb);
                densoRecordList.add(rowData);
            }
            for (Object densoRecord : densoRecordList) {
            ...
            for (Object densoRecord : densoRecordList) {
                ...
                //}else{
                //	iRec = createCSVFile4(posClassMainte, getIfPosClassMainteSelectSql(),csvFilePath11);
                //}
                iRec = createCSVFile4(posClassMainte, getIfPosClassMainteSelectSql(),csvFilePath11);
                // #6401 Mod 2021.12.10 KHOI.ND (E)
                // add 2014.11.24 #2839 nv.cuong(E)
            ...
            for (Object densoRecord : densoRecordList) {
                ...
                //}else{
                //	iRec = createCSVFile3(posSubClassMainte, getIfPosSubClassMainteSelectSql(), csvFilePath10);
                //}
                iRec = createCSVFile3(posSubClassMainte, getIfPosSubClassMainteSelectSql(), csvFilePath10);
                // #6401 Mod 2021.12.10 KHOI.ND (E)
                // add 2016.11.24 #2839 nv.cuong(E)
...
//            }
    ...
    private void getSystemControl() throws Exception {
        ...
        // CSVファイルパス取得
    	//2016.12.08 M.Akagi #3237 (S)
        //csvFilePath1 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_DIV");
        //csvFilePath2 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_DPT");
        //csvFilePath3 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_CLASS");
        //csvFilePath4 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_LINE");
        //csvFilePath5 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_ITEM");
        //csvFilePath6 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_PAYMENT");
        //csvFilePath7 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_POS_DISCOUNT");
    	csvFilePath1 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_DIV");
        csvFilePath2 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_DPT");
        csvFilePath3 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_CLASS");
        csvFilePath4 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_LINE");
        csvFilePath5 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_ITEM");
        csvFilePath6 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_PAYMENT");
        csvFilePath7 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_INI_ALL_POS_DISCOUNT");

        // add 2016.11.24 #2839 nv.cuong(S)
        //csvFilePath8 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_DIV");
        //csvFilePath9 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_DPT");
        //csvFilePath10 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_CLASS");
        //csvFilePath11 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_LINE");
        //csvFilePath12 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_ITEM");
        //csvFilePath13 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_PAYMENT");
        //csvFilePath14 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_POS_DISCOUNT");
        csvFilePath8 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_DIV");
        csvFilePath9 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_DPT");
        csvFilePath10 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_CLASS");
        csvFilePath11 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_LINE");
        csvFilePath12 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_ITEM");
        csvFilePath13 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_PAYMENT");
        csvFilePath14 = ResorceUtil.getInstance().getPropertie("FIVI_IFDIR_ALL_POS_DISCOUNT");
        // add 2016.11.24 #2839 nv.cuong(E)
        //2016.12.08 M.Akagi #3237 (E)
...
/********** ＳＱＬ生成処理 **********/
    ...
    /**
     * IF_INI_PLU_TANPINからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_PLU_TANPINからEIGYO_DT、TENPO_CDを取得SQL
     */
    ...
    /**
     * IF_INI_PLU_TANPINからデータを取得するSQLを取得する
     *
     * @return IF_INI_PLU_TANPINからデータを取得SQL
     */
    private String getIfPluTanpinMainteSelectSql() throws SQLException {
        ...
        // #6167 MSTB993 Mod 2020.07.13 KHAI.NN (S)
        //sql.append("	,SUBSTR(RPAD(NVL(IPT.SYOHIN_NA, ' '), 60), 0, 30) SYOHIN_NA ");
        // #6227 MSTB993 Mod 2020.09.18 KHAI.NN (S)
        //sql.append("	,SUBSTR(RPAD(NVL(IPT.SYOHIN_NA, ' '), 240), 0, 120) SYOHIN_NA ");
        sql.append("	,SUBSTR(RPAD(NVL(IPT.SYOHIN_NA, ' '), 60), 0, 30) SYOHIN_NA ");
        // #6227 MSTB993 Mod 2020.09.18 KHAI.NN (E)
        // #6167 MSTB993 Mod 2020.07.13 KHAI.NN (E)
        ...
        //sql.append("	,LPAD(NVL(TRIM(IPT.ZEI_RT), '0'), 3, '0') ZEI_RT ");
        sql.append(" 	,CASE IPT.ZEI_KB ");
        sql.append(" 	WHEN '3' THEN '"+ SP3 +"' ");
        ...
        sql.append("	, SUBSTR(RPAD(NVL(IPT.LABEL_COUNTRY_NA,' '),50),0,25) ");     
        // add 2016.12.12 #3049 nv.cuong(E)
        // #3765 MSTB993 2017.02.09 S.Takayama (S)
        sql.append("	, SUBSTR(RPAD(NVL(IPT.INJI_HANBAI_TN_EN,' '),16),0,8) ");
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_PLU_TANPIN IPT ");
        sql.append("WHERE ");
    ...
    /**
     * IF_INI_POS_PAYMENTからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_PAYMENTからEIGYO_DT、TENPO_CDを取得SQL
     */
    ...
    /**
     * IF_INI_POS_PAYMENTからデータを取得するSQLを取得する
     *
     * @return IF_INI_POS_PAYMENTからデータを取得SQL
     */
    private String getIfPosPaymentMainteSelectSql() throws SQLException {
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_POS_PAYMENT IPP ");
        sql.append("WHERE ");
    ...
    /**
     * IF_INI_POS_DISCOUNTからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_DISCOUNTからEIGYO_DT、TENPO_CDを取得SQL
     */
    private String getIfPosDiscountEigodtAndTenpocdSelectSql() throws SQLException {
        ...
        // add 2014.11.24 #2839 nv.cuong(E)
        sql.append("FROM ");
        sql.append("	IF_INI_POS_DISCOUNT ");
        sql.append("GROUP BY ");
        sql.append("	EIGYO_DT ");
        sql.append("	,TENPO_CD ");
        // add 2016.11.24 #2839 nv.cuong(S)
    ...
    /**
     * IF_INI_POS_DISCOUNTからデータを取得するSQLを取得する
     *
     * @return IF_INI_POS_DISCOUNTからデータを取得SQL
     */
    private String getIfPosDiscountMainteSelectSql() throws SQLException {
        ...
        sql.append("	,SUBSTR(RPAD(NVL(IPD.CARD_KB, ' '), 2), 0, 1) CARD_KB ");
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_POS_DISCOUNT IPD ");
        sql.append("WHERE ");
    ...
    /**
     * IF_INI_POS_BUMONからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_BUMONからEIGYO_DT、TENPO_CDを取得SQL
     */
    ...
    /**
     * IF_INI_POS_BUMONからデータを取得するSQLを取得する
     *
     * @return IF_INI_POS_BUMONからデータを取得SQL
     */
    private String getIfPosBumonMainteSelectSql() throws SQLException {
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_POS_BUMON IPB ");
        sql.append("WHERE ");
    ...
    /**
     * IF_INI_POS_DPTからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_DPTからEIGYO_DT、TENPO_CDを取得SQL
     */
    ...
    /**
     * IF_INI_POS_DPTからデータを取得するSQLを取得する
     *
     * @return IF_INI_POS_DPTからデータを取得SQL
     */
    ...
    /**
     * IF_INI_POS_CLASS_FIVIからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_CLASS_FIVIからEIGYO_DT、TENPO_CDを取得するSQL
     */
    private String getIfPosClassEigodtAndTenpocdSelectSql() throws SQLException {
        ...
        sql.append("	BATCH_DT AS EIGYO_DT ");
        sql.append("	,TENPO_CD ");
        // add 2016.11.24 nv.cuong(S)
        sql.append("	,GYOTAI_KB ");
        // add 2016.11.24 nv.cuong(E)
        sql.append("FROM ");
        sql.append("	IF_INI_POS_CLASS_FIVI ");
        sql.append("GROUP BY ");
        sql.append("	BATCH_DT ");
        sql.append("	,TENPO_CD ");
        // add 2016.11.24 #2839 nv.cuong(S)
    ...
    /**
     * IF_INI_POS_CLASS_FIVIからデータを取得するSQLを取得する
     *
     * @return IF_INI_POS_CLASS_FIVIからデータを取得するSQL
     */
    private String getIfPosClassMainteSelectSql() throws SQLException {
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_POS_CLASS_FIVI IPCV ");
        sql.append("WHERE");
    ...
    /**
     * IF_INI_POS_SUBCLASSからEIGYO_DT、TENPO_CDを取得するSQLを取得する
     *
     * @return IF_INI_POS_SUBCLASSからEIGYO_DT、TENPO_CDを取得するSQL
     */
    private String getIfPosSubClassEigodtAndTenpocdSelectSql() throws SQLException {
        ...
        // add 2016.11.24 #2839 nv.cuong(E)
        sql.append("FROM ");
        sql.append("	IF_INI_POS_SUBCLASS ");
        sql.append("GROUP BY ");
        sql.append("	BATCH_DT ");
        sql.append("	,TENPO_CD ");
        // add 2016.11.24 #2839 nv.cuong(S)
    ...
    /**
     * IF_INI_POS_SUBCLASS伝送ヘッダーを取得するSQLを取得する
     *
     * @return IF_INI_POS_SUBCLASS伝送ヘッダー取得SQL
     */
    private String getIfPosSubClassMainteSelectSql() throws SQLException {
        ...
        sql.append("FROM ");
        sql.append("	IF_INI_POS_SUBCLASS IPSC ");
        sql.append("WHERE");
...
/********** 共通処理 **********/
    ...
    /**
     * <p>タイトル: MSTB993071_PosFileCreateRow クラス</p>
     * <p>説明　: 伝送ヘッダーデータを保持する</p>
     *
     */
    class MSTB993071_PosFileCreateRow {
        ...
        // デフォルトコンストラクタは使用禁止
        private MSTB993071_PosFileCreateRow() {
        };

        /**
         * MSTB993071_PosFileCreateRow を生成
         *
         * @param eigyoDt 営業日
         * @param tenpoCd 店舗コード
         */
        public MSTB993071_PosFileCreateRow(String eigyoDt, String tenpoCd, String gyotaiKb) {
            this.eigyoDt = eigyoDt;
            this.tenpoCd = tenpoCd;
            // add 2016.11.24 #2839 nv.cuong(S)
            if(gyotaiKb != null){
            	this.gyotaiKb = gyotaiKb.trim();
            }else{
