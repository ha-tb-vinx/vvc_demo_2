 ...
 *
 */
public class MSTB904170_DWHFileSendIf {
	 ...
	 * @param dataBase
	 */
	public MSTB904170_DWHFileSendIf( MasterDataBase db ) {
	}

	/**
	 * コンストラクタ
	 */
	public MSTB904170_DWHFileSendIf() {
	}
	...
	protected FtpInfo createFtpInfo() {
		...
		// ファイル名の設定
		setFtpFileName(ftpInfo, mst000101_ConstDictionary.DWH_FTP_FILE_SYO_SYOHN);
		setFtpFileName(ftpInfo, mst000101_ConstDictionary.DWH_FTP_FILE_SYO_SYOHN_MS);
		setFtpFileName(ftpInfo, mst000101_ConstDictionary.DWH_FTP_FILE_MST_TENPO);
		setFtpFileName(ftpInfo, mst000101_ConstDictionary.DWH_FTP_FILE_SIR_SIIRE);
		setFtpFileName(ftpInfo, mst000101_ConstDictionary.DWH_FTP_FILE_MST_CTGRY);
