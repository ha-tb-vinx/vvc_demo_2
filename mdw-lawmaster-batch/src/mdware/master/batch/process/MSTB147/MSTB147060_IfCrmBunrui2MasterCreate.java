...
/**
 * <p> タイトル: 海外CRM用IFラインマスタ作成処理 </p>
 * <p> 著作権: Copyright (c) </p>
 * <p> 会社名: VVC </p>
 * @author THONG.LT
 * @Version 1.00 (2025.07.10) THONG.LT #35147 対応
 */
public class MSTB147060_IfCrmBunrui2MasterCreate {
	/** CSVファイル名（ラインマスタ） */
	private static final String FILE_NAME = "HKCR0120";
	...
	public void execute() throws Exception 
	{
		...
		exporter.columnSpecs.add(new ColumnSpec("BUNRUI2_KANJI_NA", 100));
		exporter.export();
	}
	...
	private String getSelDataSQL() {
		...
		sb.append("    , IRBR2.BUNRUI2_KANJI_NA ");
		sb.append(" FROM ");
