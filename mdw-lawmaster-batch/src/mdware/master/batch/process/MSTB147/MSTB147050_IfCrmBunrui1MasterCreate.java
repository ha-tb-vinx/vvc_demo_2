...
/**
 * <p> タイトル: 海外CRM用IFDTPマスタ作成処理 </p>
 * <p> 著作権: Copyright (c) </p>
 * <p> 会社名: VVC </p>
 * @author THONG.LT
 * @Version 1.00 (2025.07.10) THONG.LT #35147 対応
 */
public class MSTB147050_IfCrmBunrui1MasterCreate {
	/** CSVファイル名（DTPマスタ） */
	private static final String FILE_NAME = "HKCR0110";
	...
	public void execute() throws Exception 
	{
		...
		exporter.columnSpecs.add(new ColumnSpec("BUNRUI1_KANJI_NA", 100));
		exporter.export();
	}
	...
	private String getSelDataSQL() {
		...
		sb.append("    , IRBR1.BUNRUI1_KANJI_NA ");
		sb.append(" FROM ");
