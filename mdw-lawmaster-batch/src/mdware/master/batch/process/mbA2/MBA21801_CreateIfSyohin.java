...
/**
 * <p>タイトル:MSTB111180_IF商品マスタ作成</p>
 * <p>著作権: Copyright (c) </p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author T.Yokoyama
 * @version 1.00 初版作成
 * @version 1.10 結合Ｔ障害対応 2038,2041 okada
 * @Version 1.11 (2016.08.17) M.Akagi #1944 FIVImart対応
 * @Version 1.12 (2016.11.22) T.Han   #2800 FIVImart対応
 * @Version 1.13 (2022.06.28) SIEU.D #6620 MKH対応
 */

public class MBA21801_CreateIfSyohin{
	 ...
	 * @param dataBase
	 */
	public MBA21801_CreateIfSyohin( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA21801_CreateIfSyohin() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			try{
				...
				writeLog(Level.ERROR_INT, "内部IFスキーマ名が設定されていないため、TMP商品マスタはIFされません。");
				return;
			}

			// テーブルクリア
			writeLog(Level.INFO_INT, "IFテーブルのデータクリアを開始します。");
			DBUtil.truncateTable(db, ifSchema, "IF_R_SYOHIN");
	...
	public String getInsertSql(String timeStamp,  String batchDate) throws SQLException, Exception {
		...
		// SQL作成
		sb.append("INSERT /*+ APPEND */ INTO IF_R_SYOHIN NOLOGGING (");
		...
		// #1944対応 2016.08.17 M.Akagi (S)
		sb.append("	SIIRE_ZEI_KB, ");
		sb.append("	SIIRE_TAX_RATE_KB, ");
		sb.append("	OROSI_ZEI_KB, ");
		sb.append("	OROSI_TAX_RATE_KB, ");
		// #1944対応 2016.08.17 M.Akagi (E)
		...
		sb.append("	OROSI_BAITANKA_VL, ");
		sb.append("	OROSI_BAITANKA_NUKI_VL, ");
		// #1944対応 2016.08.17 M.Akagi (E)
		// #2800対応 2016.11.22 T.Han (S)
		sb.append("	OROSI_BAITANKA_VL_KOURI, ");	// 卸売価単価(小売税)
		// #2800対応 2016.11.22 T.Han (E)
...
//		sb.append("	CENTER_SYOMI_KIKAN_DT, ");
		...
		sb.append("FROM TMP_R_SYOHIN TB1 ");
		sb.append("	WHERE (");
		sb.append(" YUKO_DT = ");
		sb.append("	( SELECT ");
		...
		// #6620 DEL 2022.06.28 SIEU.D (S)
		// sb.append("		AND BUNRUI1_CD = TB1.BUNRUI1_CD ");
		// #6620 DEL 2022.06.28 SIEU.D (E)
		sb.append("	) OR ( ");
