...
/**
 * <p>タイトル:MSTB111040_IF大分類１マスタ作成処理</p>
 * <p>著作権: Copyright (c) </p>
...
public class MBA20401_CreateIfDaibunrui1 {
	 ...
	 * @param dataBase
	 */
	public MBA20401_CreateIfDaibunrui1( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA20401_CreateIfDaibunrui1() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			try{
				...
				writeLog(Level.ERROR_INT, "内部IFスキーマ名が設定されていないため、TMP大分類１マスタはIFされません。");
				return;
			}

			// テーブルクリア
			writeLog(Level.INFO_INT, "IFテーブルのデータクリアを開始します。");
			DBUtil.truncateTable(db, ifSchema, "IF_R_DAIBUNRUI1");
	...
	public String getInsertSql(String timeStamp) throws SQLException, Exception {
		...
		sb.append("INSERT /*+ APPEND */ INTO IF_R_DAIBUNRUI1 NOLOGGING ( ");
		sb.append("	SYSTEM_KB, ");
		sb.append("	DAIBUNRUI1_CD, ");
		sb.append("	DAIBUNRUI1_KANJI_NA, ");
		sb.append("	DAIBUNRUI1_KANA_NA, ");
		sb.append("	IF_INSERT_TS ");
		sb.append(") ");

		sb.append("SELECT DISTINCT ");
		sb.append("	TRIM(RS.SYSTEM_KB), ");
		sb.append("	TRIM(RS.DAIBUNRUI1_CD), ");
		...
		sb.append("	ON NC.SYUBETU_NO_CD = '").append(MessageUtil.getMessage(mst000101_ConstDictionary.DAIBUNRUI1, userLocal)).append("' ");
		sb.append("	AND TRIM(NC.CODE_CD) = TRIM(RS.DAIBUNRUI1_CD) ");
