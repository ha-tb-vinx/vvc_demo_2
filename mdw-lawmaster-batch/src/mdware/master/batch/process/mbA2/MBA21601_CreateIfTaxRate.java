...
public class MBA21601_CreateIfTaxRate{
	 ...
	 * @param dataBase
	 */
	public MBA21601_CreateIfTaxRate( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA21601_CreateIfTaxRate() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			try{
				...
				writeLog(Level.ERROR_INT, "内部IFスキーマ名が設定されていないため、TMP税率マスタはIFされません。");
				return;
			}

			// テーブルクリア
			writeLog(Level.INFO_INT, "IFテーブルのデータクリアを開始します。");
			DBUtil.truncateTable(db, ifSchema, "IF_R_TAX_RATE");
	...
	public String getInsertSql(String timeStamp) throws SQLException, Exception {
		...
		// SQL作成
		sb.append("INSERT /*+ APPEND */ INTO IF_R_TAX_RATE NOLOGGING (");
		...
		sb.append("	TRIM(TAX_RT), ");
		sb.append("	'").append(timeStamp).append("' ");
		sb.append("FROM TMP_R_TAX_RATE ");
