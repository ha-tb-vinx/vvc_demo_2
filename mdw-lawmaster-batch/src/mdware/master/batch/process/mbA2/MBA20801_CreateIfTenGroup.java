...
/**
 * <p>タイトル:MSTB111080_IF店グルーピングマスタ作成処理</p>
 * <p>著作権: Copyright (c) </p>
...
public class MBA20801_CreateIfTenGroup{
	 ...
	 * @param dataBase
	 */
	public MBA20801_CreateIfTenGroup( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA20801_CreateIfTenGroup() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			try{
				...
				writeLog(Level.ERROR_INT, "内部IFスキーマ名が設定されていないため、TMP店グルーピングマスタはIFされません。");
				return;
			}

			// テーブルクリア
			writeLog(Level.INFO_INT, "IFテーブルのデータクリアを開始します。");
			DBUtil.truncateTable(db, ifSchema, "IF_R_TENGROUP");
	...
	public String getInsertSql(String timeStamp) throws SQLException, Exception {
		...
		// SQL作成
		sb.append("INSERT /*+ APPEND */ INTO IF_R_TENGROUP NOLOGGING (");
