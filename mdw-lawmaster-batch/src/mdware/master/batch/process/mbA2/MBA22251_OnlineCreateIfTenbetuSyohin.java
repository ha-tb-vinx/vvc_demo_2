...
/**
 * <p>タイトル:MBA22251_ONLINE IF店別商品データ作成処理</p>
...
public class MBA22251_OnlineCreateIfTenbetuSyohin{
	 ...
	 * @param dataBase
	 */
	public MBA22251_OnlineCreateIfTenbetuSyohin( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA22251_OnlineCreateIfTenbetuSyohin() {
	...
	public void execute() throws Exception {
		...
		try {
			...
			try{
				...
				writeLog(Level.ERROR_INT, "内部IFスキーマ名が設定されていないため、オンライン店別商品マスタはIFされません。");
				return;
			}

			// テーブルクリア
			writeLog(Level.INFO_INT, "IFテーブルのデータクリアを開始します。");
			DBUtil.truncateTable(db, ifSchema, "IF_DT_TENBETU_SYOHIN_ONLINE");
	...
	protected String getInsertSql(String timeStamp) {
		...
		sb.append("INSERT /*+ APPEND */ INTO IF_DT_TENBETU_SYOHIN_ONLINE NOLOGGING ( ");
		sb.append("TENPO_CD, ");
