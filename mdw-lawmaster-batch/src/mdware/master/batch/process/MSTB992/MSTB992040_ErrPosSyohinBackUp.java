...
/**
 * 
 * <p>タイトル: MSTB992040_ErrPosSyohinBackUp.java クラス</p>
 * <p>説明　: WK_PLU店別商品のエラーデータの内容を、ERR_PLU店別商品に取込む</p>
 * <p>著作権: Copyright (c) 2013</p>
 * <p>会社名: VINX</p>
 * @version 3.00 (2013.11.27) T.Ooshiro [CUS00063] ランドローム様対応 POSインターフェイス仕様変更対応
 *
 */
public class MSTB992040_ErrPosSyohinBackUp {
	...
	// // テーブル
	// private static final String TABLE_WK = "DT_ERR_TEC_PLU" // ERR_PLU店別商品
	 ...
	 * @param dataBase
	 */
	public MSTB992040_ErrPosSyohinBackUp(DataBase db) {
		this.db = db;
		if (db == null) {
	 ...
	 * コンストラクタ
	 */
	public MSTB992040_ErrPosSyohinBackUp() {
