...
public class MBA30501_CreateDaiBunrui2 {

	// CSVファイル名（大分類２マスタ）
	private static final String FILE_NAME		= "IF_R_DAIBUNRUI2.csv";
	// 区切り文字（カンマ区切り）
	 ...
	 * @param dataBase
	 */
	public MBA30501_CreateDaiBunrui2( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA30501_CreateDaiBunrui2() {
	...
	private String getSelDataSQL() {
		...
		ssb.append( "    TRIM(DAIBUNRUI2_CD)      AS DAIBUNRUI2_CD, " );
		ssb.append( "    TRIM(MAX(DAIBUNRUI1_CD)) AS DAIBUNRUI1_CD " );
		ssb.append( "FROM " );
		ssb.append( "    TMP_R_SYOHIN_TAIKEI " );
		ssb.append( "GROUP BY " );
		ssb.append( "    SYSTEM_KB, " );
		ssb.append( "    DAIBUNRUI2_CD " );
		...
		sb.append( "    RST.DAIBUNRUI2_CD AS DAIBUNRUI2_CD, " );
		//カンマデータ出力対応2015.11.05 kanno
		//sb.append( "    RN.KANJI_NA       AS DAIBUNRUI2_KANJI_NA, " );
		//sb.append( "    RN.KANA_NA        AS DAIBUNRUI2_KANA_NA, " );
		sb.append( "  '\"'  ||  RN.KANJI_NA   || '\"'  AS DAIBUNRUI2_KANJI_NA, " );
		sb.append( "  '\"'  ||  RN.KANA_NA    || '\"'  AS DAIBUNRUI2_KANA_NA, " );
		sb.append( "    RST.DAIBUNRUI1_CD AS DAIBUNRUI1_cd " );
		sb.append( "FROM " );
		sb.append( "    (" ).append(ssb).append( ") RST " );
		sb.append( "LEFT JOIN " );
		sb.append( "    TMP_R_NAMECTF RN " );
		sb.append( "ON " );
		sb.append( "    RN.SYUBETU_NO_CD = '" ).append( MessageUtil.getMessage(mst000101_ConstDictionary.DAIBUNRUI2, userLocal) ).append( "' " );
		sb.append( "AND " );
		sb.append( "    RN.CODE_CD = RST.DAIBUNRUI2_CD " );
		sb.append( "AND " );
	...
	private StringBuffer createRowData(ResultSet rs) throws SQLException, Exception{
		...
		// 大分類２名称（漢字）
		if( rs.getString("DAIBUNRUI2_KANJI_NA") != null ){
			sb.append( rs.getString("DAIBUNRUI2_KANJI_NA").trim() );
		}
		sb.append( SPLIT_CODE );

		// 大分類２名称（カナ）
		if( rs.getString("DAIBUNRUI2_KANA_NA") != null ){
			sb.append( rs.getString("DAIBUNRUI2_KANA_NA").trim() );
		}
		sb.append( SPLIT_CODE );
