...
public class MBA30101_CreateBunrui1 {

	// CSVファイル名（分類１マスタ）
	private static final String FILE_NAME		= "IF_R_BUNRUI1.csv";
	// 区切り文字（カンマ区切り）
	 ...
	 * @param dataBase
	 */
	public MBA30101_CreateBunrui1( MasterDataBase db ) {
...
//		this.batchId = batchId;
	...
	private String getSelDataSQL() {
		...
		ssb.append( "    TRIM(BUNRUI1_CD) AS BUNRUI1_CD, " );
		ssb.append( "    TRIM(MAX(DAIBUNRUI2_CD)) AS DAIBUNRUI2_CD " );
		ssb.append( "FROM " );
		ssb.append( "    TMP_R_SYOHIN_TAIKEI " );
		ssb.append( "GROUP BY " );
		ssb.append( "    SYSTEM_KB, " );
		ssb.append( "    BUNRUI1_CD " );
		...
		sb.append( "    RST.BUNRUI1_CD    AS BUNRUI1_CD, " );
		//カンマデータ出力対応2015.11.05 kanno
		//sb.append( "    RN.KANJI_NA       AS BUNRUI1_KANJI_NA, " );
		//sb.append( "    RN.KANA_NA        AS BUNRUI1_KANA_NA, " );
		sb.append( "  '\"'  ||  RN.KANJI_NA   || '\"'  AS BUNRUI1_KANJI_NA, " );
		sb.append( "  '\"'  ||  RN.KANA_NA    || '\"'  AS BUNRUI1_KANA_NA, " );
		...
		sb.append( "ON " );
		sb.append( "    RN.SYUBETU_NO_CD = '" ).append( MessageUtil.getMessage(mst000101_ConstDictionary.BUNRUI1, userLocal) ).append( "' " );
		sb.append( "AND " );
		sb.append( "    RN.CODE_CD = RST.BUNRUI1_CD " );
		sb.append( "AND " );
	...
	private StringBuffer createRowData(ResultSet rs) throws SQLException, Exception{
		...
		// 分類１名称（漢字）
		if( rs.getString("BUNRUI1_KANJI_NA") != null ){
			sb.append( rs.getString("BUNRUI1_KANJI_NA").trim() );
		}
		sb.append( SPLIT_CODE );

		// 分類１名称（カナ）
		if( rs.getString("BUNRUI1_KANA_NA") != null ){
			sb.append( rs.getString("BUNRUI1_KANA_NA").trim() );
		}
		sb.append( SPLIT_CODE );
