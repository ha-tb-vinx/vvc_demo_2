...
public class MBA30401_CreateDaiBunrui1 {

	// CSVファイル名（大分類１マスタ）
	private static final String FILE_NAME		= "IF_R_DAIBUNRUI1.csv";
	// 区切り文字（カンマ区切り）
	 ...
	 * @param dataBase
	 */
	public MBA30401_CreateDaiBunrui1( MasterDataBase db ) {
	 ...
	 * コンストラクタ
	 */
	public MBA30401_CreateDaiBunrui1() {
	...
	private String getSelDataSQL() {
		...
		ssb.append( "    TRIM(DAIBUNRUI1_CD)   AS DAIBUNRUI1_CD " );
		ssb.append( "FROM " );
		ssb.append( "    TMP_R_SYOHIN_TAIKEI " );
		ssb.append( "GROUP BY " );
		ssb.append( "    SYSTEM_KB, " );
		ssb.append( "    DAIBUNRUI1_CD " );
		...
		//sb.append( "    RN.KANJI_NA       AS DAIBUNRUI1_KANJI_NA, " );
		//sb.append( "    RN.KANA_NA        AS DAIBUNRUI1_KANA_NA " );
		sb.append( "  '\"'  ||  RN.KANJI_NA   || '\"'  AS DAIBUNRUI1_KANJI_NA, " );
		sb.append( "  '\"'  ||  RN.KANA_NA    || '\"'  AS DAIBUNRUI1_KANA_NA " );
		sb.append( "FROM " );
		...
		sb.append( "ON " );
		sb.append( "    RN.SYUBETU_NO_CD = '" ).append( MessageUtil.getMessage(mst000101_ConstDictionary.DAIBUNRUI1, userLocal) ).append( "' " );
		sb.append( "AND " );
		sb.append( "    RN.CODE_CD = RST.DAIBUNRUI1_CD " );
		sb.append( "AND " );
	...
	private StringBuffer createRowData(ResultSet rs) throws SQLException, Exception{
		...
		// 大分類１名称（漢字）
		if( rs.getString("DAIBUNRUI1_KANJI_NA") != null ){
			sb.append( rs.getString("DAIBUNRUI1_KANJI_NA").trim() );
		}
		sb.append( SPLIT_CODE );

		// 大分類１名称（カナ）
		if( rs.getString("DAIBUNRUI1_KANA_NA") != null ){
			sb.append( rs.getString("DAIBUNRUI1_KANA_NA").trim() );
		}
		sb.append( SPLIT_CODE );
