/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）BM商品登録画面の検索結果レコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するBM商品登録の検索結果レコード格納用クラス(DmCreatorにより自動生成)</p>
...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）BM商品登録画面の検索結果レコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するBM商品登録画面の検索結果レコード格納用クラス(DmCreatorにより自動生成)</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author FSIABC E.Yoshikawa
 * @version 1.0(2005/04/19)初版作成
 */
public class mst750301_BMSyohinListBean
{
	...
	public static final int KANJI_RN_MAX_LENGTH = 20;				//販区略式名称の長さ
	...
	public static final int INSERT_USER_NM_MAX_LENGTH = 20;		//作成者氏名の長さ
	public static final int UPDATE_USER_NM_MAX_LENGTH = 20;		//更新者氏名の長さ
	public static final int SENTAKU_MAX_LENGTH = 1;				//処理選択の長さ

	private String hanku_cd = null;				//販区コード
	private String kanji_rn = null;				//販区略式名称
	private String syohin_cd = null;				//商品コード
	private String hinmei_kanji_na = null;			//漢字品名
	private long   baitanka_vl= 0;					//マスタ売価
	private String insert_ts = null;				//作成年月日
	private String insert_user_id = null;			//作成者社員ID
	private String update_ts = null;				//更新年月日
	private String update_user_id = null;			//更新者社員ID
	private String delete_fg = null;				//削除フラグ
	private String insert_user_nm = null;			//作成者氏名
	private String update_user_nm = null;			//更新者氏名
	 ...
	 */
	public static mst750301_BMSyohinListBean getmst730301_BundleMixPlanListBean(DataHolder dataHolder)
	{
		mst750301_BMSyohinListBean bean = null;
		...
		try
		{
			...
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst750301_BMSyohinListBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return mst750301_BMSyohinListBean コピー後のクラス
	 */
	public mst750301_BMSyohinListBean createClone()
	{
		mst750301_BMSyohinListBean bean = new mst750301_BMSyohinListBean();
		bean.setHankuCd(this.getHankuCd());
		bean.setKanjiRn(this.getKanjiRn());
		bean.setSyohinCd(this.getSyohinCd());
		bean.setHinmeiKanjiNa(this.getHinmeiKanjiNa());
		bean.setBaitankaVl(this.getBaitankaVl());
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst750301_BMSyohinListBean ) ) return false;
