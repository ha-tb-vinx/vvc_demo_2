 ...
 * @version 1.0(2005/03/04)初版作成
 */
public class mst530101_TenpoBean
{
...
//	↑↑ＤＢバージョンアップによる変更（2005.05.19）
	 ...
	 */
	public static mst530101_TenpoBean getRTENPOBean(DataHolder dataHolder)
	{
		mst530101_TenpoBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst530101_TenpoDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst530101_TenpoBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
...
//		↑↑ＤＢバージョンアップによる変更（2005.05.19）
	 ...
	 */
	public mst530101_TenpoBean createClone()
	{
...
//		↑↑ＤＢバージョンアップによる変更（2005.05.19）
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst530101_TenpoBean ) ) return false;
