 ...
 * @version 1.0(2005/03/16)初版作成
 */
public class mst290301_SetSyohinBean
{
	 ...
	 */
	public static mst550301_TenHankuBean getRTENHANKUBean(DataHolder dataHolder)
	{
		mst550301_TenHankuBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst550301_TenHankuDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst550301_TenHankuBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 */
	public mst550301_TenHankuBean createClone()
	{
		mst550301_TenHankuBean bean = new mst550301_TenHankuBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst550301_TenHankuBean ) ) return false;
