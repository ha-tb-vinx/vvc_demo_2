 ...
 * @version 1.0(2005/03/11)初版作成
 */
public class mst580101_TenGroupNoBean
{
...
//			      ↑↑2006.06.23 zhangxia カスタマイズ修正↑↑
	...
	public static final int UPDATE_TS_FOR_UPDATE_MAX_LENGTH = 20;//更新年月日の長さ
...
//	private long groupno_cd = 0;	//グルーピングNO
	...
	private String update_ts_for_update = null;	//更新年月日 for update
	 ...
	 */
	public static mst580101_TenGroupNoBean getRTengroupnoBean(DataHolder dataHolder)
	{
		mst580101_TenGroupNoBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst580101_TenGroupNoDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst580101_TenGroupNoBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
...
//					      ↑↑2006.06.23 zhangxia カスタマイズ修正↑↑	
	 ...
	 */
	public mst580101_TenGroupNoBean createClone()
	{
...
//					      ↑↑2006.06.23 zhangxia カスタマイズ修正↑↑	
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst580101_TenGroupNoBean ) ) return false;
