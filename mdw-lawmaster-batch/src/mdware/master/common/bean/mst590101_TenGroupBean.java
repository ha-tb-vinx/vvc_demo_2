...
//	 ↑↑2006.06.29 wangluping カスタマイズ修正↑↑
	 ...
	 */
	public static mst590101_TenGroupBean getRTengroupBean(DataHolder dataHolder)
	{
		mst590101_TenGroupBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst590101_TenGroupDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst590101_TenGroupBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
...
//	 ↑↑2006.06.29 wangluping カスタマイズ修正↑↑	
	 ...
	 */
	public mst590101_TenGroupBean createClone()
	{
...
//		 ↑↑2006.06.29 wangluping カスタマイズ修正↑↑
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst590101_TenGroupBean ) ) return false;
