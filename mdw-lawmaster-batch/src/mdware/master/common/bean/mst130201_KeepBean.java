 ...
 * @version 1.0(2005/03/25)初版作成
 */
public class mst130201_KeepBean
{
    private static final StcLog stcLog = StcLog.getInstance();
// ↓↓2006.06.27 yangbo カスタマイズ修正↓↓
...
//  ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
    ...
    public static final int HACHUTANI_IRISU_QT_MAX_LENGTH       = 5;    //発注単位(入数)の長さ
...
//  2006.01.26 T.hattori　追加　開始　先付け登録項目追加
    private String sakiduketouroku           = "";              //先付け登録
//  2006.01.26 T.hattori　追加　終了　先付け登録項目追加
	...
	private String hinban_cd       		  = "";              //品番コード
    private String tanpin_cd                 = "";              //単品コード
    private String hinmoku_cd                = "";              //品目コード
...
//  private String ten_haiso_kanri_na        = "";              //店別配送先管理名
	...
	private String save_plu_send_dt      = "";                  //DB-PLU送信日
...
// ↓↓2006.06.27 yangbo カスタマイズ修正↓↓
    ...
    public String kikaku_kanji_na2          = "";               //漢字規格2
    public String kikaku_kana_na2           = "";               //カナ規格2
  	public String  area_cd                  = "";               //地区コード
    public  String unit_na                      = "";           //ユニット名
    public  String subclass_na               = "";              //サブクラス名
    public String  areacd_na                 = "";              //地区名
    public String  hachutani_na              = "";              //発注単位呼称
    public String  syohikigen                = "";              //消費期限
    public String  honbuzai_kb               = "";              //本部在庫区分
    public String  fujisyohin_kb               = "";            //商品区分
    public String  pb_kb                   = "";                //ＰＢ区分
    public String  daichotenpo               = "";              //商品台帳（店舗）
    public String  daichohonbu               = "";              //商品台帳（本部）
    public String  syuzeihokokukb               = "";           //酒税報告分類
    public String  daichosiiresaki             = "";            //商品台帳（仕入先）
    public String  daisino_kb                  = "";            //プライスシール種類
// ↑↑2006.06.27 yangbo カスタマイズ修正↑↑
//  ↓↓仕様変更（2005.07.28）↓↓
...
// ↑↑2006.06.27 yangbo カスタマイズ修正↑↑
    ...
    private static final String INIT_PAGE   = "mst130101_SyohinJyukyoInit"; //初期画面JSPを取得
    private static final String EDIT_PAGE   = "mst130201_SyohinJyukyoEdit"; //新規・修正画面JSPを取得
    private static final String VIEW_PAGE   = "mst130301_SyohinJyukyoView"; //削除・照会画面JSPを取得
...
// ↑↑2006.06.27 yangbo カスタマイズ修正↑↑
    ...
    {
        return "'" + cutString(this.hinmoku_na,HINMOKU_CD_MAX_LENGTH) + "'";
    }
    public String getHinmokuNaHTMLString()
    {
        return HTMLStringUtil.convert(cutString(this.hinmoku_na,HINMOKU_CD_MAX_LENGTH));
    }
...
//  hinmei_kanjiに対するセッターとゲッターの集合
    ...
    {   if( "".equals(max_hachutani_qt)) {
        this.max_hachutani_qt = "";
    }else { this.max_hachutani_qt= String.valueOf((long)Double.parseDouble(max_hachutani_qt));
          }
    	return true;
    }
...
*/
  ...
  // ↓↓2006.06.27 yangbo カスタマイズ修正↓↓
    ...
    // daisi_no_nbに対するセッターとゲッターの集合
    public boolean setDaisiNokb(String daisi_no_nb)
    {
        this.daisi_no_nb = daisi_no_nb;
        return true;
    }
