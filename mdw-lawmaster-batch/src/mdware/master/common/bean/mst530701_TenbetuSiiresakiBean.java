 ...
 * @version 1.0(2005/03/18)初版作成
 */
public class mst530701_TenbetuSiiresakiBean
{
	 ...
	 */
	public static mst530701_TenbetuSiiresakiBean getRTENBETUSIIRESAKIBean(DataHolder dataHolder)
	{
		mst530701_TenbetuSiiresakiBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst530701_TenbetuSiiresakiDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst530701_TenbetuSiiresakiBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return RTENBETUSIIRESAKIBean コピー後のクラス
	 */
	public mst530701_TenbetuSiiresakiBean createClone()
	{
		mst530701_TenbetuSiiresakiBean bean = new mst530701_TenbetuSiiresakiBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst530701_TenbetuSiiresakiBean ) ) return false;
