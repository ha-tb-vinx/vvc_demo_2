/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス  mst840101_Tenkabutu用添加物マスタのレコード格納用クラス</P>
 * <P>説明 : 新ＭＤシステムで使用するmst840101_Tenkabutu用添加物マスタのレコード格納用クラス(DmCreatorにより自動生成)</P>
 ...
 * @see なし								
 */
public class mst840101_TenkabutuBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	public static final int TENKABUTU_CD_MAX_LENGTH = 4;		//添加物NO
	public static final int TENKABUTU_NA_MAX_LENGTH = 30;	//添加物名
	...
	private String tenkabutu_cd = null;	//添加物NO
	private String tenkabutu_na = null;	//添加物名
	...
	/**
	 * RTenkabutuBeanを１件のみ抽出したい時に使用する
	 */
	public static mst840101_TenkabutuBean getRTenkabutuBean(DataHolder dataHolder)
	{
		mst840101_TenkabutuBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst840101_TenkabutuDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst840101_TenkabutuBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return mst840101_TenkabutuBean コピー後のクラス
	 */
	public mst840101_TenkabutuBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst840101_TenkabutuBean ) ) return false;
