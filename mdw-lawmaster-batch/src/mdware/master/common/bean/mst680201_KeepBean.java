/**
 * <p>タイトル: 新ＭＤシステム（マスタ管理）自動発注本部数量停止マスタの画面表示データ格納用クラス</p>
 * <p>説明: 	新ＭＤシステムで使用する自動発注本部数量停止マスタの画面表示データ格納用クラス</p>
 * <p>著作権: 	Copyright (c) 2005</p>
 * <p>会社名: 	Vinculum Japan Corp.</p>
 * @author 	VJC A.Tozaki
 * @version 	1.0(2005/08/05)初版作成
 */
...
public class mst680201_KeepBean
{
	...
	private String groupno_cd				= "";				// 店配列
	private String ten_groupno_nm			= "";				// 店配列名
	
	private String daihyo_yuko_dt			= "";				// 代表有効日
	private String tenhanku_cd				= "";				// 店販区コード
	private String tenpo_cd				= "";				// 店舗コード
	private String yuko_dt 				= null;			// 有効日
	private String chikan_kb				= "";				// 置換区分
	private String teisi_qt				= "";				// 停止数量
	

//BUGNO-S052 2005.05.14 Y.Jozawa START
//	private static final String INIT_PAGE = "mst680101_JidoHachuHonbuSuryoTeisiInit";	// 初期画面JSPを取得
//	private static final String EDIT_PAGE = "mst680201_JidoHachuHonbuSuryoTeisiEdit";	// 新規・削除画面JSPを取得
//	private static final String VIEW_PAGE = "mst680301_JidoHachuHonbuSuryoTeisiView";	// 照会画面JSPを取得
...
//BUGNO-S052 2005.05.14 Y.Jozawa END
	...
	// ten_groupno_nmに対するセッターとゲッターの集合
	public boolean setTenGroupNoNm(String ten_groupno_nm)	
	{
		this.ten_groupno_nm = ten_groupno_nm;
		return true;
	}
	public String getTenGroupNoNm()
	{
		return this.ten_groupno_nm;
	}
	// daihyo_yuko_dtに対するセッターとゲッターの集合
	public boolean setDaihyoYukoDt(String daihyo_yuko_dt)	
	{
		this.daihyo_yuko_dt = daihyo_yuko_dt;
		return true;
	}
	public String getDaihyoYukoDt()
	{
		return this.daihyo_yuko_dt;
	}
}
