 ...
 * <p>説明: 新ＭＤシステムで使用する店別キーPLUマスタのDMクラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/04/13)初版作成
 */
public class mst720101_KeyPluInqDM extends DataModule
{
	private DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
	/**
	 * コンストラクタ
	 */
	public mst720101_KeyPluInqDM()
	{
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		mst720101_KeyPluInqBean bean = (mst720101_KeyPluInqBean)beanMst;
		StringBuffer sb = new StringBuffer();
