/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）物流店舗マスタ（生鮮）の画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する物流店舗マスタ（生鮮）の画面表示データ格納用クラス</p>
 ...
 * @version 1.0(2005/03/19)初版作成
 */
public class mst560301_KeepBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	private String s_gyosyu_cd = null;	//小業種コード
	private String s_gyosyu_nm = null;	//小業種名
//	BUGNO-006 2005.04.20 S.Murata START
	private String s_gyosyu_nm_mae = null;//小業種名変換前
...
//BUGNO-S005 2005.04.21 S.Takahashi START
	private String changflg = null;	//項目変更フラグ
//BUGNO-S005 2005.04.21 S.Takahashi END

//BUGNO-S052 2005.05.14 Y.Jozawa START
	private static final String INIT_PAGE = "mst560101_ButuryuTenpoInit";	// 初期画面JSPを取得
	private static final String EDIT_PAGE = "mst560201_ButuryuTenpoEdit";	// 新規・修正画面JSPを取得
	private static final String VIEW_PAGE = "mst560301_ButuryuTenpoView";	// 照会画面JSPを取得
 ...
 * <br>
 * Ex)<br>
 * getSGyosyuNm();　戻り値　文字列<br>
 * <br>
 * @return String 文字列
 */
	public String getSGyosyuNm()
	{
		return this.s_gyosyu_nm;
	}
 ...
 * @param String 設定する文字列
 */
	public boolean setSGyosyuNm(String s_gyosyu_nm)
	{
		this.s_gyosyu_nm = s_gyosyu_nm;
		return true;
	}
/**
 * 小業種コードに対するゲッター<br>
 ...
 */
	 ...
	 * <br>
	 * Ex)<br>
	 * getL_gyosyu_cd();　戻り値　大業種<br>
	 * <br>
	 * @return String 明細配列
	 */
	public String getL_gyosyu_cd() {
		return l_gyosyu_cd;
	}
	 ...
	 * <br>
	 * Ex)<br>
	 * setL_gyosyu_cd(List);<br>
	 * <br>
	 * @param String 設定する大業種
	 */
	public void setL_gyosyu_cd(String string) {
		l_gyosyu_cd = string;
	}
...
//	BUGNO-006 2005.04.20 S.Murata START
	 ...
	 * <br>
	 * Ex)<br>
	 * getS_gyosyu_nm_mae();　戻り値　小業種名変換前<br>
	 * <br>
	 * @return String 小業種名変換前
	 */
	public String getS_gyosyu_nm_mae() {
		return s_gyosyu_nm_mae;
	}
	 ...
	 * <br>
	 * Ex)<br>
	 * setS_gyosyu_nm_mae(String);<br>
	 * <br>
	 * @param String 設定する小業種名変換前
	 */
	public void setS_gyosyu_nm_mae(String string) {
		s_gyosyu_nm_mae = string;
	}
//	BUGNO-006 2005.04.20 S.Murata END

//	BUGNO-S005 2005.04.20 S.Takahashi START
	/**
	 * 項目変更フラグに対するゲッター<br>
	 * <br>
	 * Ex)<br>
	 * getS_gyosyu_nm_mae();　戻り値　項目変更フラグ<br>
	 * <br>
	 * @return String 項目変更フラグ
	 */
	public String getChangeFlg() {
		return this.changflg;
	}
	 ...
	 * setS_gyosyu_nm_mae(String);<br>
	 * <br>
	 * @param String 設定する項目変更フラグ
	 */
	public void setChangeFlg(String changeflg) {
		this.changflg = changeflg;
	}
//	BUGNO-S005 2005.04.20 S.Takahashi END
