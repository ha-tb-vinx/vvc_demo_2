/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）品種一括送信トランのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する品種一括送信トランのレコード格納用クラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/04/22)初版作成
 */
public class mst760101_HinsyuSendBean
{
	...
	/**
	 * mst760101_HinsyuSendBeanを１件のみ抽出したい時に使用する
	 */
	public static mst760101_HinsyuSendBean getmst760101_HinsyuSendBean(DataHolder dataHolder)
	{
		mst760101_HinsyuSendBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst760101_HinsyuSendDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst760101_HinsyuSendBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return RHINSYUSENDBean コピー後のクラス
	 */
	public mst760101_HinsyuSendBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst760101_HinsyuSendBean ) ) return false;
