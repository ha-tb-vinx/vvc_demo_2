/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス  mst800101_Keiryoki用計量器マスタのレコード格納用クラス</P>
 * <P>説明 : 新ＭＤシステムで使用するmst800101_Keiryoki用計量器マスタのレコード格納用クラス(DmCreatorにより自動生成)</P>
 ...
 * @see なし
 */
public class mst800101_KeiryokiBean
{
	 ...
	 */
	public static mst800101_KeiryokiBean getRKeiryokiBean(DataHolder dataHolder)
	{
		mst800101_KeiryokiBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst800101_KeiryokiDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst800101_KeiryokiBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 */
	public mst800101_KeiryokiBean createClone()
	{
		mst800101_KeiryokiBean bean = new mst800101_KeiryokiBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst800101_KeiryokiBean ) ) return false;
