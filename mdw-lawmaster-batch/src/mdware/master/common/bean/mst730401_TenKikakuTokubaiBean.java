/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）店別企画特売マスタのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する店別企画特売マスタのレコード格納用クラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/04/15)初版作成
 */
public class mst730401_TenKikakuTokubaiBean
{
	...
	public static final int DELETE_FG_MAX_LENGTH = 8;				//削除フラグの長さ
	...
	private String henko_dt = null;									//更新日
	...
	/**
	 * RTENKIKAKUTOKUBAIBeanを１件のみ抽出したい時に使用する
	 */
	public static mst730401_TenKikakuTokubaiBean getRTENKIKAKUTOKUBAIBean(DataHolder dataHolder)
	{
		mst730401_TenKikakuTokubaiBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst730401_TenKikakuTokubaiDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst730401_TenKikakuTokubaiBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	{
		return cutString(this.sinki_toroku_dt,UPDATE_TS_MAX_LENGTH);
	}
	...
	{
		return HTMLStringUtil.convert(cutString(this.sinki_toroku_dt,UPDATE_TS_MAX_LENGTH));
	}
	 ...
	 * @return RTENKIKAKUTOKUBAIBean コピー後のクラス
	 */
	public mst730401_TenKikakuTokubaiBean createClone()
	{
		mst730401_TenKikakuTokubaiBean bean = new mst730401_TenKikakuTokubaiBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst730401_TenKikakuTokubaiBean ) ) return false;
