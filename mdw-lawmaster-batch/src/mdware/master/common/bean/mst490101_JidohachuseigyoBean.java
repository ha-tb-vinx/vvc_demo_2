 ...
 * @version 1.0(2005/03/31)初版作成
 */
public class mst490101_JidohachuseigyoBean
{
	...
	/**
	 * mst490101_JidohachuseigyoBeanを１件のみ抽出したい時に使用する
	 */
	public static mst490101_JidohachuseigyoBean getmst490101_JidohachuseigyoBean(DataHolder dataHolder)
	{
		mst490101_JidohachuseigyoBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst490101_JidohachuseigyoDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst490101_JidohachuseigyoBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return mst490101_JidohachuseigyoBean コピー後のクラス
	 */
	public mst490101_JidohachuseigyoBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst490101_JidohachuseigyoBean ) ) return false;
