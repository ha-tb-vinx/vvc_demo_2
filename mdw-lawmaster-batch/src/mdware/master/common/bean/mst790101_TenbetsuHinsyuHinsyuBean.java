/**
 * <p>タイトル	：新ＭＤシステム（マスタ管理）店別品種(品種)マスタのレコード格納用クラス</p>
 * <p>説明		：新ＭＤシステムで使用する店別品種(品種)マスタのレコード格納用クラス(DmCreatorにより自動生成)</p>
...
public class mst790101_TenbetsuHinsyuHinsyuBean
{
	...
	/**
	 * mst790101_TenbetsuHinsyuHinsyuBeanを１件のみ抽出したい時に使用する
	 */
	public static mst790101_TenbetsuHinsyuHinsyuBean getmst790101_TenbetsuHinsyuHinsyuBean(DataHolder dataHolder)
	{
		mst790101_TenbetsuHinsyuHinsyuBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst790101_TenbetsuHinsyuHinsyuDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst790101_TenbetsuHinsyuHinsyuBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return mst790101_TenbetsuHinsyuHinsyuBean コピー後のクラス
	 */
	public mst790101_TenbetsuHinsyuHinsyuBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst790101_TenbetsuHinsyuHinsyuBean ) ) return false;
