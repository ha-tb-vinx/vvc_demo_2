/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス  mst800101_Keiryoki用計量器マスタのDMクラス</P>
 * <P>説明 : 新ＭＤシステムで使用するmst800101_Keiryoki用計量器マスタのDMクラス(DmCreatorにより自動生成)</P>
 ...
 * @see なし								
 */
public class mst800101_KeiryokiDM extends DataModule
{
	private DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
	/**
	 * コンストラクタ
	 */
	public mst800101_KeiryokiDM()
	{
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		mst800101_KeiryokiBean bean = (mst800101_KeiryokiBean)beanMst;
		StringBuffer sb = new StringBuffer();
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		sb.append(" keiryoki2_na = ");
		sb.append("TRIM('" + conv.convertString( bean.getKeiryoki2Na() ) + "')");
		sb.append(",");
		
		sb.append(" keiryoki3_na = ");
		sb.append("TRIM('" + conv.convertString( bean.getKeiryoki3Na() ) + "')");
		sb.append(",");
