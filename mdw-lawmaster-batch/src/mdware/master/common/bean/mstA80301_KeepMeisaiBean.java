/**
 * <p>タイトル: mstA80301_KeepMeisaiBeanクラス</p>
 * <p>説明: 新ＭＤシステムで使用するプライスシール・棚割表発行リクエスト画面表示データ(明細)格納用クラス</p>
 * <p>著作権: Copyright (c) 2006</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author yaoyujun
 * @version 1.0 (2006/08/10) 初版作成
 */
 ...
 * @version 1.0 (2006/08/10) 初版作成
 */
public class mstA80301_KeepMeisaiBean {
	...
	private String MaxRows = "";//画面の最大行数
