 ...
 * @version 1.0(2005/03/18)初版作成
 */
public class mst530901_TenhankuBean
{
	 ...
	 */
	public static mst530901_TenhankuBean getRTENHANKUBean(DataHolder dataHolder)
	{
		mst530901_TenhankuBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst530901_TenhankuDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst530901_TenhankuBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 */
	public mst530901_TenhankuBean createClone()
	{
		mst530901_TenhankuBean bean = new mst530901_TenhankuBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst530901_TenhankuBean ) ) return false;
