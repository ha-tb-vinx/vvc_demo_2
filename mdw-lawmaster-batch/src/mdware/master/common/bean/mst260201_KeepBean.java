 ...
 * @version 1.0(2005/03/24)初版作成
 */
public class mst260201_KeepBean
{
...
//	↑↑仕様追加（2005.07.07）↑↑
	...
	private String trihikisakiHinban = "";	//取引先品番
	
//	↓↓仕様追加（2005.07.06）↓↓
	private String color_cd	= ""; //カラーコード
	private String color_nm	= ""; //カラーコード名称
	private String size_cd		= ""; //サイズコード
	private String size_nm		= ""; //サイズコード名称
	private String assort_pt_cd	= ""; //アソートパターンコード
//	↑↑仕様追加（2005.07.06）↑↑
	...
	private List asortList      = new ArrayList(); //アソートパターン一覧
	private String gyosyu_kb    = ""; //商品マスタ.業種区分
...
//BUGNO-S052 2005.05.14 Y.Gotoh START
	private static final String INIT_PAGE 		= "mst260101_SyokaiDonyuIryouInit";	// 初期画面JSPを取得
	private static final String EDIT_PAGE 		= "mst260201_SyokaiDonyuIryouEdit";	// 新規・修正画面JSPを取得
	private static final String VIEW_PAGE 		= "mst260301_SyokaiDonyuIryouView";	// 削除・照会画面JSPを取得
...
//	↓↓仕様追加（2005.07.06）↓↓
	...
	/**
	 * アソートパターンコードに対するセッター<br>
	 * <br>
	 * Ex)<br>
	 * setAssortPtCd("文字列");<br>
	 * <br>
	 * @param String 設定する文字列
	 */
...
//	↓↓仕様追加（2005.07.06）↓↓
	 ...
	 * @param String 設定する文字列
	 */
	public boolean setAssortPtCd(String assort_pt_cd)
	{
		this.assort_pt_cd = assort_pt_cd;
		return true;
	}
	/**
	 * サイズコード名称に対するゲッター<br>
	 ...
	 * @return String 文字列
	 */
	public String getAssortPtCd()
	{
		return this.assort_pt_cd;
	}
//	↑↑仕様追加（2005.07.06）↑↑
...
//	}
	 ...
	 * @return String 文字列
	 */
	public String getTrihikisakiHinban() {
		return trihikisakiHinban;
	}
	/**
	 * 取引先品番に対するセッター<br>
	 * <br>
	 * @param String 設定する文字列
	 */
	public void setTrihikisakiHinban(String string) {
		trihikisakiHinban = string;
	}
	...
	/**
	 * アソートパターン一覧に対するゲッター<br>
	 * <br>
	 * @return List リスト
	 */
	public List getAsortList() {
		return asortList;
	}
	/**
	 * アソートパターン一覧に対するセッター<br>
	 * <br>
	 * @param List 設定するリスト
	 */
	public void setAsortList(List list) {
		asortList = list;
	}
	

	/**
	 * 商品マスタ.業種区分に対するゲッター<br>
	 * <br>
	 * @return String 文字列
	 */
	...
	/**
	 * 商品マスタ.業種区分に対するセッター<br>
	 * <br>
	 * @param String 設定する文字列
	 */
	public void setGyosyu_kb(String string) {
		gyosyu_kb = string;
	}
...
//↓↓仕様変更（2005.07.07）↓↓
  ...
  public String getAsortPatternHTMLOptionString()
  {
	  ...
	  buf.append(getOption(mst005701_AsortPatternDictionary.PATTERN5));
  ...
  private String getOption(mst005701_AsortPatternDictionary dictionary){
	  ...
	  if(assort_pt_cd == null){
		  assort_pt_cd = "";
	  }
	  assort_pt_cd = assort_pt_cd.trim();

	  //アソートパターン2
	  buf.append("<OPTION VALUE=\"");
	  buf.append(dictionary.getCode());
	  buf.append("\"");
	  if(dictionary.getCode().equals(assort_pt_cd)){
		  buf.append(" SELECTED ");
	  }
	  buf.append(" >");
  ...
  public String getAsortPatternNameHTMLString()
  {
	  ...
	  String name = mst005701_AsortPatternDictionary.getStatus(assort_pt_cd).toString();
