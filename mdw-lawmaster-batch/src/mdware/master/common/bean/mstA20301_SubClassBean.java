/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）サブクラス登録(一覧)表示データ(明細)格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するサブクラス登録(一覧)表示データ(明細)格納用クラス</p>
...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）サブクラス登録(一覧)の画面表示データ(明細)格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するサブクラス登録(一覧)の画面表示データ(明細)格納用クラス</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author yaoyujun
 * @version 1.0(2006.07.18)初版作成
...
public class mstA20301_SubClassBean {
