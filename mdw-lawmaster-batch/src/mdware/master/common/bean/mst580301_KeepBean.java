/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）店グルーピングNOマスタの画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する店グルーピングNOマスタの画面表示データ格納用クラス</p>
 ...
 * @version 1.0(2005/03/11)初版作成
 */
public class mst580301_KeepBean
{
...
//	private long groupno_cd = 0;	//グルーピングNO
...
//    ↑↑2006.06.23 zhangxia カスタマイズ修正↑↑
	...
	private mst580101_TenGroupNoBean[] meisai = new mst580101_TenGroupNoBean[100];//mst580101_TenGroupNoBean明細配列
...
//BUGNO-S052 2005.05.14 Y.Jozawa START
	private static final String INIT_PAGE = "mst580101_TenGroupNoInit";	// 初期画面JSPを取得
	private static final String EDIT_PAGE = "mst580201_TenGroupNoEdit";	// 新規・修正画面JSPを取得
	private static final String VIEW_PAGE = "mst580301_TenGroupNoView"; 	// 照会画面JSPを取得
 ...
 */
	 ...
	 */
	public mst580101_TenGroupNoBean[] getMeisai() {
		return meisai;
	}
	 ...
	 */
	public void setMeisai(mst580101_TenGroupNoBean[] beans) {
		meisai = beans;
	}
