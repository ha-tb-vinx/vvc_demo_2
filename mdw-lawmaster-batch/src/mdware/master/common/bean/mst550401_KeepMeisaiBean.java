/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス  mst550401用店別販区マスタの画面項目(一覧)格納用クラス</P>
 * <P>説明 : 新ＭＤシステムで使用するmst550401用店別販区マスタの画面項目格納用クラス</P>
 ...
 * @see なし								
 */
public class mst550401_KeepMeisaiBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	private ArrayList Meisai		= new ArrayList();	// 一覧の明細(1ページ分)
	private ArrayList MeisaiAll	= new ArrayList();	// 一覧の明細(全件)
