 ...
 * @version 1.0(2006/06/27)初版作成
 */
public class mstA70101_TorokuhyoBYSyoninBean
{
	...
	/**
	 * mstA70101_TorokuhyoBYSyoninBeanを１件のみ抽出したい時に使用する
	 */
	public static mstA70101_TorokuhyoBYSyoninBean getmst380401_ExcelUploadBean(DataHolder dataHolder)
	{
		mstA70101_TorokuhyoBYSyoninBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mstA70101_TorokuhyoBYSyoninDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mstA70101_TorokuhyoBYSyoninBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	public boolean setTsUketsukeNo(long uketsuke_no)
	{
		this.ts_uketsuke_no = uketsuke_no;
		return true;
	}
	...
	public boolean setTsMaxNeireRt(double max_neire_rt)
	{
		this.ts_max_neire_rt = max_neire_rt;
		return true;
	}
	...
	public boolean setTsMaxUritankaVl(long max_uritanka_vl)
	{
		this.ts_max_uritanka_vl = max_uritanka_vl;
		return true;
	}
	 ...
	 * @return mstA70101_TorokuhyoBYSyoninBean コピー後のクラス
	 */
	public mstA70101_TorokuhyoBYSyoninBean createClone()
	{
		mstA70101_TorokuhyoBYSyoninBean bean = new mstA70101_TorokuhyoBYSyoninBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mstA70101_TorokuhyoBYSyoninBean ) ) return false;
