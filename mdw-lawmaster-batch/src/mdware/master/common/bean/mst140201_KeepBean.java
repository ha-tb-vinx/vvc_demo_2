/**
 * <p>タイトル: 新ＭＤシステム（マスター管理） 商品マスタ登録（加工食品）の画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する  商品マスタ登録（加工食品）の画面表示データ格納用クラス</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author Sirius Kikuchi
 * @version 1.0(2005/04/12)初版作成
 ...
 * 　　　　　　　　入荷商品コード(nyuka_syohin_cd)⇒3件→13桁
 */
public class mst140201_KeepBean
{
...
//	public static final int KIKAKU_KANA_NA_MAX_LENGTH 			= 40;	//カナ規格の長さ
	public static final int HINMEI_KANA_NA_MAX_LENGTH 			= 18;	//カナ品名の長さ
	public static final int KIKAKU_KANA_NA_MAX_LENGTH 			= 6;	//カナ規格の長さ
//	↑↑仕様変更（2005.08.18）↑↑
	...
	public static final int SIIRE_HINBAN_CD_MAX_LENGTH			= 13;	//仕入先品番の長さ
...
// ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
	...
	public static final int DAIHYO_HAISO_CD_MAX_LENGTH 			= 5;	//代表配送先コードの長さ
...
// ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
	...
	public static final int REC_HINMEI_KANJI_NA_MAX_LENGTH 		= 30;	//POSレシート品名(漢字)の長さ
	public static final int REC_HINMEI_KANA_NA_MAX_LENGTH 		= 30;	//POSレシート品名(カナ)の長さ
	...
	public static final int NYUKA_SYOHIN_CD_MAX_LENGTH 			= 3;	//入荷時商品コードの長さ
...
// ↑↑2005.11.29 Y.Inaba 検索初期設定を照会にする
	...
	private String hinmei_kanji			 = "";				//商品名
...
//	2006.0122 T.hattori　追加　開始　先付け登録項目追加
	private String sakiduketouroku			 = "";				//先付け登録
//	2006.0122 T.hattori　追加　終了　先付け登録項目追加
...
//	↑↑仕様変更（2005.08.10）↑↑
	...
	private static final String INIT_PAGE   = "mst140101_SyohinKakouSyokuhinInit";	//初期画面JSPを取得
	private static final String EDIT_PAGE   = "mst140201_SyohinKakouSyokuhinEdit";	//新規・修正画面JSPを取得
	private static final String VIEW_PAGE   = "mst140301_SyohinKakouSyokuhinView";	//削除・照会画面JSPを取得
