...
/**
 * <p>タイトル: なんちゃってバイヤー承認画面の内容保存してみましょう</p>
 * <p>説明: 新ＭＤシステムで使用する品種一括送信画面の画面情報格納用クラス</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author FSIABC E.Yoshikawa
...
//共通項目ここまで
     ...
     * @param update_from	
     */
    public void setUpdateFrom(String update_from){
     ...
     * @param update_to	
     */
    public void setUpdateTo(String update_to){
     ...
     * @param jyotai_kb	
     */
    public void setJyotaiKb(String jyotai_kb){
	...
	public boolean isBackgroundListSelected() {
		...
		for (int i = 0; i < meisai.size(); i++) {
			mst999999_TourokuBYSyoninBean bean = (mst999999_TourokuBYSyoninBean)meisai.get(i);
