/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス mst530201_Tenpo用店マスタ(詳細)の画面項目格納用クラス</P>
 ...
 * @see なし								
 */
public class mst530201_KeepBean
{
