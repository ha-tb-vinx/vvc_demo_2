/**
 * <P>タイトル : 店販区用有効日チェッククラス</P>
 * <P>説明 : 店販区用有効日チェッククラス</P>
...
public class mst000206_TenhankuEffectiveDayCheckBean {
	/**
	 * 有効データの存在チェック
	 * <br>
	 ...
	 */
	public static String getYukoDtCheck(String tableNm, String yukoDt, String kanriKb, String kanriCd, String tenpoCd,
										Object Keepbeen, mst000101_DbmsBean db, String addValue) throws Exception,SQLException{
		//メッセージ取得
...
//		param[0]         = new String(ErrorFlg);
	 ...
	 * @return boolean
	 */
	public static boolean isYukoDtCheckInsert(mst000101_DbmsBean db, String kanriKb, String kanriCd, String tenpoCd,
		...
		String MasterDT = RMSTDATEUtil.getMstDateDt();
		//過去データ取得
		ResultSet resPst = db.executeQuery(selYukoDtPast("R_TENHANKU", kanriKb, kanriCd, tenpoCd, yukoDt));
		...
		if (!existsFg) {
			//未来データ取得
			ResultSet resFtr = db.executeQuery(selYukoDtFuture("R_TENHANKU", kanriKb, kanriCd, tenpoCd, yukoDt));
	...
	public static String isYukoDtCheckUpdete(mst000101_DbmsBean db, Map msg, String tableNm, String kanriKb, String kanriCd,
							String tenpoCd, String yukoDt, String addValue) throws SQLException {
