/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）値札タグ発行情報照会CSV明細データDMクラス</p>
 * <p>説明: 新ＭＤシステムで使用する値札タグ発行情報照会CSV明細データDMクラス</p>
 ...
 */
public class mstB40401_NefudaTagHakkoInfoDetailDM extends DataModule
{
	/**
	 * コンストラクタ
	 */
	public mstB40401_NefudaTagHakkoInfoDetailDM()
	{
		...
		throws SQLException
	{
		...
		bean.setSiiresakiCd(encodingString(mst000401_LogicBean.chkNullString( rest.getString("SIIRESAKI_CD") )));
		bean.setSiiresakiNm(encodingString(mst000401_LogicBean.chkNullString( rest.getString("SIIRESAKI_NM") )));
...
//		↓↓2007.01.22 H.Yamamoto カスタマイズ修正↓↓
		bean.setNefudaKb(encodingString(mst000401_LogicBean.chkNullString( rest.getString("NEFUDA_KB") )));
//		↑↑2007.01.22 H.Yamamoto カスタマイズ修正↑↑
		...
		bean.setHachuDt(encodingString(mst000401_LogicBean.chkNullString( rest.getString("HATYU_DT") )));
		bean.setNohinDt(encodingString(mst000401_LogicBean.chkNullString( rest.getString("NOHIN_DT") )));
		bean.setTenpoCd(encodingString(mst000401_LogicBean.chkNullString( rest.getString("TENPO_CD") )));
		bean.setSuryoQt(encodingString(mst000401_LogicBean.chkNullString( rest.getString("SURYO_QT") )));
	...
	public String getSelectSql( Map map )
	{
		...
		sb.append("SELECT ");
		sb.append("Z.SIIRESAKI_CD as SIIRESAKI_CD ");
		sb.append(", ");
		sb.append("G.KANJI_RN as SIIRESAKI_NM ");
		sb.append(", ");
		sb.append("Z.HINBAN_CD as HINBAN_CD ");
		sb.append(", ");
		sb.append("Z.UNIT_CD as UNIT_CD ");
		sb.append(", ");
		sb.append("Z.SIIRE_HINBAN_CD as SIIRE_HINBAN_CD ");
		sb.append(", ");
		sb.append("Z.SYOHIN_CD as SYOHIN_CD ");
		sb.append(", ");
		sb.append("Z.HINMEI_KANJI_NA AS HINMEI_KANJI_NA ");
		sb.append(", ");
		sb.append("Z.BAITANKA_VL AS BAITANKA_VL ");
		sb.append(", ");
		sb.append("Z.KESHI_BAIKA_VL AS KESHI_BAIKA_VL ");
		if (map.get("system_kb") != null && map.get("system_kb").equals("T")) {				//イキナリ比較すると、NULL時にNullPointerExceptionが発生するため、nullでないことを確認
			...
			sb.append(", ");
			sb.append("Z.COLOR_NA AS COLOR_NA ");	//カラー名称(漢字規格)
			sb.append(", ");
			sb.append("Z.SIZE_NA AS SIZE_NA ");	//サイズ名称(漢字規格２)
		}else {
			//衣料以外
			sb.append(", ");
...
//		↓↓2007.01.22 H.Yamamoto カスタマイズ修正↓↓
		sb.append(", ");
		sb.append("Z.NEFUDA_KB as NEFUDA_KB ");
//		↑↑2007.01.22 H.Yamamoto カスタマイズ修正↑↑
		sb.append(", ");
		sb.append("F.KANJI_RN as NEFUDA_KB_NM ");
		sb.append(", ");
		sb.append("Z.HANBAI_ST_DT as HANBAI_ST_DT ");
		sb.append(", ");
		sb.append("Z.HANBAI_ED_DT as HANBAI_ED_DT ");
		sb.append(", ");
		sb.append("Z.RUIKEI_KEIYAKU_QT as RUIKEI_KEIYAKU_QT ");
		sb.append(", ");
		sb.append("Z.KONKAI_TUIKEIYAKU_QT as KONKAI_TUIKEIYAKU_QT ");
		sb.append(", ");
		sb.append("Z.HATYU_DT as HATYU_DT ");
		sb.append(", ");
		sb.append("Z.NOHIN_DT as NOHIN_DT ");
		sb.append(", ");
		sb.append("Z.TENPO_CD as TENPO_CD ");
		sb.append(", ");
		sb.append("Z.SURYO_QT as SURYO_QT ");
		...
		sb.append("SELECT ");
		sb.append("S.SYSTEM_KB as SYSTEM_KB ");
		sb.append(", ");
		sb.append("S.BUMON_CD as BUMON_CD ");
		sb.append(", ");
		...
		sb.append(", ");
		sb.append("J.HINMEI_KANJI_NA AS HINMEI_KANJI_NA ");
		sb.append(", ");
		sb.append("J.BAITANKA_VL AS BAITANKA_VL ");
		sb.append(", ");
		sb.append("J.KESHI_BAIKA_VL AS KESHI_BAIKA_VL ");
		sb.append(", ");
		sb.append("J.COLOR_CD AS COLOR_CD ");
		sb.append(", ");
		sb.append("J.SIZE_CD AS SIZE_CD ");
		sb.append(", ");
		sb.append("J.KIKAKU_KANJI_NA AS COLOR_NA ");
		sb.append(", ");
		sb.append("J.KIKAKU_KANJI_2_NA AS SIZE_NA ");
		sb.append(", ");
		sb.append("J.FUJI_SYOHIN_KB  as FUJI_SYOHIN_KB ");
		sb.append(", ");
		sb.append("J.NEFUDA_KB  as NEFUDA_KB ");
		sb.append(", ");
		sb.append("J.HANBAI_ST_DT as HANBAI_ST_DT ");
		sb.append(", ");
		sb.append("J.HANBAI_ED_DT as HANBAI_ED_DT ");
		sb.append(", ");
		...
		sb.append(", ");
		sb.append("D.NOHIN_DT as NOHIN_DT ");
		sb.append(", ");
		sb.append("D.TENPO_CD as TENPO_CD ");
		sb.append(", ");
		sb.append("D.SURYO_QT as SURYO_QT ");
		...
		sb.append(", ");
		sb.append("B.KIKAKU_KANJI_NA AS KIKAKU_KANJI_NA ");
		sb.append(", ");
		sb.append("B.KIKAKU_KANJI_2_NA AS KIKAKU_KANJI_2_NA ");
		sb.append(", ");
		...
		sb.append("( ");
		sb.append("SELECT ");
		sb.append("D2.BUMON_CD as BUMON_CD ");
		sb.append(", ");
		sb.append("D2.SYOHIN_CD  as SYOHIN_CD ");
		sb.append(", ");
		sb.append("D2.HATYU_DT as HATYU_DT ");
		sb.append(", ");
		sb.append("D2.NOHIN_DT as NOHIN_DT ");
		sb.append(", ");
		sb.append("D2.TENPO_CD as TENPO_CD ");
		sb.append(", ");
		sb.append("SUM(D2.SURYO_QT) as SURYO_QT ");
		sb.append("FROM ");
		sb.append("R_SYOKAIDONYU D2 ");
		sb.append("WHERE ");
		sb.append("D2.DELETE_FG = '").append(mst000801_DelFlagDictionary.INAI.getCode()).append("' ");
		//bumon_cd に対するWHERE区
		if( map.get("bumon_cd") != null && ((String)map.get("bumon_cd")).trim().length() > 0 )
		{
			sb.append(" AND ");
			sb.append("D2.BUMON_CD = '").append(conv.convertWhereString(StringUtility.charFormat( (String)map.get("bumon_cd") , 4, "0", true))).append("' ");
		}
		//syohin_cd に対するWHERE区
		if( map.get("syohin_cd") != null && ((String)map.get("syohin_cd")).trim().length() > 0 )
		{
			sb.append(" AND ");
			sb.append("D2.syohin_cd = '").append(conv.convertWhereString( (String)map.get("syohin_cd") )).append("' ");
		}
		...
		if(map.get("hachu_st_dt") != null && map.get("hachu_st_dt").toString().trim().length() != 0){
			if(map.get("hachu_en_dt") != null && map.get("hachu_en_dt").toString().trim().length() != 0){
				sb.append(" AND ");
				sb.append("D2.HATYU_DT <= '").append(map.get("hachu_en_dt")).append("' ");
				sb.append(" AND ");
				sb.append("D2.HATYU_DT >= '").append(map.get("hachu_st_dt")).append("' ");
			} else {
				sb.append(" AND ");
				sb.append("D2.HATYU_DT >= '").append(map.get("hachu_st_dt")).append("' ");
			}
		...
		if(map.get("nohin_st_dt") != null && map.get("nohin_st_dt").toString().trim().length() != 0){
			if(map.get("nohin_en_dt") != null && map.get("nohin_en_dt").toString().trim().length() != 0){
				sb.append(" AND ");
				sb.append("D2.NOHIN_DT <= '").append(map.get("nohin_en_dt")).append("' ");
				sb.append(" AND ");
				sb.append("D2.NOHIN_DT >= '").append(map.get("nohin_st_dt")).append("' ");
			} else {
				sb.append(" AND ");
				sb.append("D2.NOHIN_DT >= '").append(map.get("nohin_st_dt")).append("' ");
			}
		...
		sb.append("GROUP BY ");
		sb.append("D2.BUMON_CD ");
		sb.append(", ");
		sb.append("D2.SYOHIN_CD ");
		sb.append(", ");
		sb.append("D2.HATYU_DT ");
		sb.append(", ");
		sb.append("D2.NOHIN_DT ");
		sb.append(", ");
		sb.append("D2.TENPO_CD ");
		sb.append(") D ");
		...
		sb.append("WHERE ");
		sb.append("S.BUMON_CD = D.BUMON_CD ");
		sb.append(" AND ");
		sb.append("S.SYOHIN_CD = D.SYOHIN_CD ");
		...
		sb.append(" AND ");
		sb.append("E.CODE_CD = Z.SYSTEM_KB || Z.FUJI_SYOHIN_KB ");
		sb.append(" AND ");
		...
		sb.append(" AND ");
		sb.append("F.CODE_CD = Z.SYSTEM_KB || Z.NEFUDA_KB ");
		sb.append(" AND ");
		...
		sb.append(" AND ");
		sb.append("(G2.SIIRESAKI_CD = Z.SIIRESAKI_CD ");
		sb.append(" OR ");
		sb.append("SUBSTR(G2.SIIRESAKI_CD,1,6) = Z.SIIRESAKI_CD) ");
		sb.append(" AND ");
		...
		if (map.get("system_kb") != null && map.get("system_kb").equals("T")) {				//イキナリ比較すると、NULL時にNullPointerExceptionが発生するため、nullでないことを確認
			...
			sb.append(" AND ");
			sb.append("H.CODE_CD = Z.COLOR_CD ");
			sb.append(" AND ");
			...
			sb.append(" AND ");
			sb.append("I.CODE_CD = Z.SIZE_CD ");
			sb.append(" AND ");
			sb.append("I.DELETE_FG = '").append(mst000801_DelFlagDictionary.INAI.getCode()).append("' ");
		}

		sb.append("ORDER BY ");
		sb.append("Z.HATYU_DT ");
		sb.append(", ");
		sb.append("Z.BUMON_CD ");
		sb.append(", ");
		sb.append("Z.HINBAN_CD ");
		sb.append(", ");
		sb.append("Z.SIIRE_HINBAN_CD ");
		sb.append(", ");
		sb.append("Z.SYOHIN_CD ");
		sb.append(", ");
		sb.append("Z.NOHIN_DT ");
		sb.append(", ");
		sb.append("Z.TENPO_CD ");
