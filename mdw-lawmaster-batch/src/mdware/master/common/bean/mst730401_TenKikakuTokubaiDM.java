/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）店別企画特売マスタのDMクラス</p>
 * <p>説明: 新ＭＤシステムで使用する店別企画特売マスタのDMクラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/04/15)初版作成
 */
public class mst730401_TenKikakuTokubaiDM extends DataModule
{
	private DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
	/**
	 * コンストラクタ
	 */
	public mst730401_TenKikakuTokubaiDM()
	{
...
//A.Tozaki		
		...
		sb.append(", ");
		sb.append("delete_fg ");
		sb.append("from R_TENKIKAKUTOKUBAI ");
		...
		if( map.get("henko_dt_aft") != null && ((String)map.get("delete_fg_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		mst730401_TenKikakuTokubaiBean bean = (mst730401_TenKikakuTokubaiBean)beanMst;
		StringBuffer sb = new StringBuffer();
		sb.append("insert into ");
		sb.append("R_TENKIKAKUTOKUBAI (");
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		StringBuffer sb = new StringBuffer();
		sb.append("update ");
		sb.append("R_TENKIKAKUTOKUBAI set ");
		if( bean.getInsertTs() != null && bean.getInsertTs().trim().length() != 0 )
		{
			befKanma = true;
			sb.append(" insert_ts = ");
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		sb.append("R_TENKIKAKUTOKUBAI where ");
		sb.append(" tenpo_cd = ");
		sb.append("'" + conv.convertWhereString( bean.getTenpoCd() ) + "'");
		sb.append(" AND");
		sb.append(" kikaku_tokubaino_cd = ");
