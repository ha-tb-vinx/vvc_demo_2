/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）マスタ管理用日付テーブルのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するマスタ管理用日付テーブルのレコード格納用クラス(DmCreatorにより自動生成)</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author FSIABC E.Yoshikawa
 * @version 1.0(2005/04/16)初版作成
 */
 ...
 * @version 1.0(2005/04/16)初版作成
 */
public class mst710501_MstDateBean
{
	 ...
	 */
	public static mst710501_MstDateBean getmst710501_MstDateBean(DataHolder dataHolder)
	{
		mst710501_MstDateBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst710501_MstDateDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst710501_MstDateBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 */
	public mst710501_MstDateBean createClone()
	{
		mst710501_MstDateBean bean = new mst710501_MstDateBean();
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst710501_MstDateBean ) ) return false;
