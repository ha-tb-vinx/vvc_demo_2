...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）衣料グルーピングマスタの画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する衣料グルーピングマスタの画面表示データ格納用クラス</p>
 * <p>著作権: Copyright (c) 2006</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author K.Tanigawa
 * @version 1.0(2006/10/04)初版作成
 * @see mdware.master.common.bean.mst590201_KeepBean.java
 */
public class mst980101_KeepBean
{
	private static final StcLog stcLog = StcLog.getInstance();
	private String bumon_cd             = null;	//部門
	private String bumon_kanji_rn       = null;	//部門名
	private String hinsyu_cd            = "";      //品番
	private String hinsyu_kanji_rn      = "";      //品番名
	...
	private static final String INIT_PAGE = "mst980101_IryoGroupInit";	// 初期画面JSPを取得
	private static final String EDIT_PAGE = "mst980201_IryoGroupEdit";	// 新規・修正画面JSPを取得
	private static final String VIEW_PAGE = "mst980301_IryoGroupView";	// 照会画面JSPを取得
...
//	}
	...
	public String getBumonKanjiRn() {
		return (bumon_kanji_rn == null) ? "" : bumon_kanji_rn.trim();
	}
 ...
 */
	...
	public String getHinsyuKanjiRn() {
		return (this.hinsyu_kanji_rn == null) ? "" : this.hinsyu_kanji_rn.trim();
	}
