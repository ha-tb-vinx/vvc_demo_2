/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）店別販区マスタのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する店別販区マスタのレコード格納用クラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/03/17)初版作成
 */
public class mst550101_TenHankuLBean
{
	...
	public static final int HANKU_NA_MAX_LENGTH = 20;//販区名称の長さ
	public static final int HINSHU_CD_MAX_LENGTH = 4;//品種コードの長さ
	public static final int HINSHU_NA_MAX_LENGTH = 20;//品種名称の長さ
	public static final int TENPO_CD_MAX_LENGTH = 6;//店舗コード (FK)の長さ
	public static final int TENPO_NA_MAX_LENGTH = 20;//店舗名称の長さ
	public static final int YUKO_DT_MAX_LENGTH = 8;//有効日の長さ
	public static final int TENHANKU_CD_MAX_LENGTH = 4;//店販区コードの長さ
	public static final int TENHANKU_NA_MAX_LENGTH = 20;//店販区名称の長さ
	public static final int INSERT_TS_MAX_LENGTH = 20;//作成年月日の長さ
	public static final int INSERT_USER_ID_MAX_LENGTH = 10;//作成者名の長さ
	public static final int INSERT_USER_NA_MAX_LENGTH = 20;//作成者名の長さ
	public static final int UPDATE_TS_MAX_LENGTH = 20;//更新年月日の長さ
	public static final int UPDATE_USER_ID_MAX_LENGTH = 10;//更新者名の長さ
	public static final int UPDATE_USER_NA_MAX_LENGTH = 20;//更新者名の長さ
	public static final int DELETE_FG_MAX_LENGTH = 1;//削除フラグの長さ
	public static final int SENTAKU_MAX_LENGTH = 1;//処理選択
	public static final int YUKO_DT_REAL_MAX_LENGTH = 8;//有効日（実際）の長さ
	...
	private String hinshu_cd = null;	//品種コード
	private String hinshu_na = null;	//品種名称
	...
	private String tenhanku_na = null;	//店販区名称
	private String insert_ts = null;	//作成年月日
	private String insert_user_id = null;	//作成者名
	private String insert_user_na = null;	//作成者名
	private String update_ts = null;	//更新年月日
	private String update_user_id = null;	//更新者名
	private String update_user_na = null;	//更新者名
	private String delete_fg = null;	//削除フラグ
	private String sentaku = "0";	//処理選択
	private String yuko_dt_real = null;	//有効日
	...
	/**
	 * RTENHANKUBeanを１件のみ抽出したい時に使用する
	 */
	public static mst550101_TenHankuLBean getRTENHANKUBean(DataHolder dataHolder)
	{
		mst550101_TenHankuLBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst550101_TenHankuLDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst550101_TenHankuLBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	// yuko_dt_realに対するセッターとゲッターの集合
	public boolean setYukoDtReal(String yuko_dt_real)
	{
		this.yuko_dt_real = yuko_dt_real;
		return true;
	}
	public String getYukoDtReal()
	{
		return cutString(this.yuko_dt_real,YUKO_DT_REAL_MAX_LENGTH);
	}
	public String getYukoDtRealString()
	{
		return "'" + cutString(this.yuko_dt_real,YUKO_DT_REAL_MAX_LENGTH) + "'";
	}
	public String getYukoDtRealHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.yuko_dt_real,YUKO_DT_REAL_MAX_LENGTH));
	}
	...
	// insert_user_cdに対するセッターとゲッターの集合
	...
	// update_user_cdに対するセッターとゲッターの集合
	...
	public String toString()
	{
		return "  kanri_kb = " + getKanriKbString()
			...
			+ "  yuko_dt_real = " + getYukoDtRealString()
			+ " createDatabase  = " + createDatabase;
	}
	/**
	 * Objectのcloneと同様の動作を行うがObjectのメソッドはprotectedなのでpublicで別メソッドを作成した。
	 * このクラスをインスタンス化し内容をすべてセットし返す。
	 * @return RTENHANKUBean コピー後のクラス
	 */
	public mst550101_TenHankuLBean createClone()
	{
		...
		bean.setYukoDtReal(this.yuko_dt_real);
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst550101_TenHankuLBean ) ) return false;
