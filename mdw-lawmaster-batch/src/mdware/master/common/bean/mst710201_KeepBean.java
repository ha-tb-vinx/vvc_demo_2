/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）キーPLUマスタ登録画面の画面情報格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するキーPLUマスタ登録画面の画面情報格納用クラス</p>
...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）キーPLUマスタの画面情報格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するキーPLUマスタ登録画面の画面情報格納用クラス</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author FSIABC E.Yoshikawa
 * @version 1.0(2005/04/13)初版作成
 */
public class mst710201_KeepBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	private String effectiveDay		= "";				//有効日（画面で入力された）
...
//共通項目ここまで
    ...
    /**
     * @return effectiveDay を戻します。
     */
    public String getEffectiveDay() {
        return effectiveDay;
    }
    /**
     * @param effectiveDay effectiveDay を設定。
     */
