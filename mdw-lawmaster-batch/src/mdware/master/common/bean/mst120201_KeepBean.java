 ...
 * 　　　　　　　　入荷商品コード(nyuka_syohin_cd)⇒3件→13桁
 */
public class mst120201_KeepBean
{
	private static final StcLog stcLog = StcLog.getInstance();
// ↓↓2006.07.05 HuangJiugen カスタマイズ修正↓↓
...
// ↓↓2006.07.14 HuangJiugen カスタマイズ修正↓↓
...
//	↑↑仕様変更（2005.08.18）↑↑
	public static final int SYOHIN_WIDTH_QT_MAX_LENGTH 			= 3;	//商品サイズ(幅)の長さ
	public static final int SYOHIN_HEIGHT_QT_MAX_LENGTH 			= 3;	//商品サイズ(高さ)の長さ
	public static final int SYOHIN_DEPTH_QT_MAX_LENGTH 			= 3;	//商品サイズ(奥行き)の長さ
...
// ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
	...
	public static final int GENTANKA_VL_MAX_LENGTH 				= 10;	//原価単価の長さ
	...
	public static final int NOHIN_KIGEN_QT_MAX_LENGTH 			= 3;	//納品期限の長さ
...
// ↓↓2006.07.12 HuangJiugen カスタマイズ修正↓↓
...
// ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
	...
	public static final int HANBAI_LIMIT_QT_MAX_LENGTH 			= 3;	//販売期限の長さ
	...
	public static final int UNIT_PRICE_TANI_KB_MAX_LENGTH 		= 2;	//ユニットプライス-単位区分の長さ
...
// ↓↓2006.07.13 HuangJiugen カスタマイズ修正↓↓
//	public static final int YORIDORI_QT_MAX_LENGTH 				= 1;	//よりどり数量の長さ
	public static final int YORIDORI_QT_MAX_LENGTH 				= 2;	//よりどり数量の長さ
// ↑↑2006.07.13 HuangJiugen カスタマイズ修正↑↑
...
// ↑↑2006.07.12 HuangJiugen カスタマイズ修正↑↑
	...
	public static final int SYUZEI_HOKOKU_KB_MAX_LENGTH 			= 2;	//酒税報告分類の長さ
...
// ↓↓2005.11.29 Y.Inaba 検索初期設定を照会にする
...
// ↓↓2006.07.05 HuangJiugen カスタマイズ修正↓↓
//	private String hanku_cd 				 = "";				//販区コード(検索)
//	private String hanku_kanji_rn 			 = "";				//販区名(検索)
...
// ↑↑2006.07.10 HuangJiugen カスタマイズ修正↑↑
	...
	private String maker_kibo_kakaku_vl 	 = "";				//メーカー希望小売り価格(税込み)
	private String nohin_ondo_kb 			 = "";				//納品温度帯
	private String comment_tx 				 = "";				//コメント
	private String ten_hachu_st_dt 		 = "";				//店舗発注開始日
	private String ten_hachu_ed_dt 		 = "";				//店舗発注終了日
...
//	private String ten_haiso_kanri_na 		 = "";				//店別配送先管理コード
	...
	private String save_plu_send_dt		 = "";				//データベースのPLU送信日
	...
	private String pc_kb 					 = "";				//PC発行区分
	private String daisi_no_nb 			 = "";				//台紙NO
	private String unit_price_tani_kb 		 = "";				//ユニットプライス-単位区分
	private String unit_price_naiyoryo_qt 	 = "";				//ユニットプライス-内容量
	private String unit_price_kijun_tani_qt = "";				//ユニットプライス-基準単量
...
// ↓↓2006.07.10 HuangJiugen カスタマイズ修正↓↓
//	private String tempHanku_cd 			 = "";				//販区コード(更新用)
// ↑↑2006.07.10 HuangJiugen カスタマイズ修正↑↑

	private String ChangeFlg 		     	 = "";				//データ変更
  	private static final String INIT_PAGE   = "mst120101_SyohinIryouJuniketaInit";	//初期画面JSPを取得
  	private static final String EDIT_PAGE   = "mst120201_SyohinIryouJuniketaEdit";	//新規・修正画面JSPを取得
  	private static final String VIEW_PAGE   = "mst120301_SyohinIryouJuniketaView";	//削除・照会画面JSPを取得
...
//	  areacd_naに対するセッターとゲッターの集合
	...
	public String getMstSiyofukKbString()
	{
		return "'" + cutString(this.mst_siyofuka_kb,MST_SIYOFUKA_KB_MAX_LENGTH) + "'";
	}
...
//	}
// ↑↑2006.07.10 HuangJiugen カスタマイズ修正↑↑
	//mark_group_naに対するセッターとゲッターの集合
	public boolean setMarkGroupNa(String mark_group_na)
	{
		this.mark_group_na = mark_group_na;
		return true;
	}
	public String getMarkGroupNa()
	{
		return this.mark_group_na;
	}
	//mark_naに対するセッターとゲッターの集合
	public boolean setMarkNa(String mark_na)
	{
		this.mark_na = mark_na;
		return true;
	}
	public String getMarkNa()
	{
		return this.mark_na;
	}
...
//	2006.01.27 T.hattori 追加　開始　先付け登録項目追加
// ↓↓2006.07.10 HuangJiugen カスタマイズ修正↓↓
//	//tempHanku_cdに対するセッターとゲッターの集合
//	public boolean setTempHankuCd(String tempHanku_cd)
//	{
//		this.tempHanku_cd = tempHanku_cd;
//		return true;
//	}
//	public String getTempHankuCd()
//	{
//		return this.tempHanku_cd;
//	}
//	//tenreigaiに対するセッターとゲッターの集合
//	public boolean setAsortment(String asortment)
//	{
//		this.asortment = asortment;
//		return true;
//	}
//	public String getAsortment()
//	{
//		return this.asortment;
//	}
// ↑↑2006.07.10 HuangJiugen カスタマイズ修正↑↑
...
// ↓↓2006.07.08 HuangJiugen カスタマイズ修正↓↓
	...
	// 登録者
	private String torokuUser = null;
	public void setTotrokuUser(String torokuUser) {
		this.torokuUser = torokuUser;
	}
	public String getTorokuUser() {
		return nullToEmpty( this.torokuUser );
	}
	...
	public String getUpdateUser() {
		return nullToEmpty( this.updateUser );
	}

	// ユニットコード
	private String unitCd;
	public String getUnitCd() {
		return nullToEmpty( unitCd );
	}
	...
	// 配布コード
	private String haifuCd;
	public String getHaifuCd() {
		return nullToEmpty( haifuCd );
	}
	public void setHaifuCd(String haifuCd) {
		this.haifuCd = haifuCd;
	}

	// サブクラスコード
	private String subclassCd;
	public String getSubclassCd() {
		return nullToEmpty( subclassCd );
	}
	...
	public String getSubclassNm() {
		return nullToEmpty( subclassNm );
	}
	public void setSubclassNm(String subclassNm) {
		this.subclassNm = subclassNm;
	}
	// 漢字規格２
	private String kikakuKanji2Na;
	public String getKikakuKanji2Na() {
		return nullToEmpty( kikakuKanji2Na );
	}
	public void setKikakuKanji2Na(String kikakuKanji2Na) {
		this.kikakuKanji2Na = kikakuKanji2Na;
	}

	// カナ規格２
	private String kikakuKana2Na;
	public String getKikakuKana2Na() {
		return nullToEmpty( kikakuKana2Na );
	}
	public void setKikakuKana2Na(String kikakuKana2Na) {
		this.kikakuKana2Na = kikakuKana2Na;
	}

	// 消札売価
	private String keshiBaikaVl;
	public String getKeshiBaikaVl() {
		return nullToEmpty( keshiBaikaVl );
	}
	public void setKeshiBaikaVl(String keshiBaikaVl) {
		this.keshiBaikaVl = keshiBaikaVl;
	}

	// 特別原価
	private String tokubetuGenkaVl;
	public String getTokubetuGenkaVl() {
		return nullToEmpty( tokubetuGenkaVl );
	}
	public void setTokubetuGenkaVl(String tokubetuGenkaVl) {
		this.tokubetuGenkaVl = tokubetuGenkaVl;
	}

	// 契約数量
	private String syokaiKeiyakuQt;
	public String getSyokaiKeiyakuQt() {
		return nullToEmpty( syokaiKeiyakuQt );
	}
	public void setSyokaiKeiyakuQt(String syokaiKeiyakuQt) {
		this.syokaiKeiyakuQt = syokaiKeiyakuQt;
	}

	// 追加契約数量
	private String konkaituiKeiyakuQt;
	public String getKonkaituiKeiyakuQt() {
		return nullToEmpty( konkaituiKeiyakuQt );
	}
	public void setKonkaituiKeiyakuQt(String konkaituiKeiyakuQt) {
		this.konkaituiKeiyakuQt = konkaituiKeiyakuQt;
	}

	// 発注単位呼称
	private String hachuTaniNa;
	public String getHachuTaniNa() {
		return nullToEmpty( hachuTaniNa );
	}
	public void setHachuTaniNa(String hachuTaniNa) {
		this.hachuTaniNa = hachuTaniNa;
	}
	// 商品区分
	private String fujiSyohinKb;
	public String getFujiSyohinKb() {
		return nullToEmpty( fujiSyohinKb );
	}
	public void setFujiSyohinKb(String fujiSyohinKb) {
		this.fujiSyohinKb = fujiSyohinKb;
	}

	// PB区分
	private String pbKb;
	public String getPbKb() {
		return nullToEmpty( pbKb );
	}
	public void setPbKb(String pbKb) {
		this.pbKb = pbKb;
	}

	// よりどり価格
	private String yoridoriVl;
	public String getYoridoriVl() {
		return nullToEmpty( yoridoriVl );
	}
	public void setYoridoriVl(String yoridoriVl) {
		this.yoridoriVl = yoridoriVl;
	}
	// POS値札受渡日
	private String nefudaUkewatasiDt;
	public String getNefudaUkewatasiDt() {
		return nullToEmpty( nefudaUkewatasiDt );
	}
	public void setNefudaUkewatasiDt(String nefudaUkewatasiDt) {
		this.nefudaUkewatasiDt = nefudaUkewatasiDt;
	}

	// POS値札受渡方法
	private String nefudaUkewatasiKb;
	public String getNefudaUkewatasiKb() {
		return nullToEmpty( nefudaUkewatasiKb );
	}
	public void setNefudaUkewatasiKb(String nefudaUkewatasiKb) {
		this.nefudaUkewatasiKb = nefudaUkewatasiKb;
	}
	// ＪＡＮメーカー名称
	private String makerNm;
	public String getMakerNm() {
		return nullToEmpty( makerNm );
	}
	...
	// 仕入先名称
	private String siiresakiNm;
	public String getSiiresakiNm() {
		return nullToEmpty( siiresakiNm );
	}
	public void setSiiresakiNm(String siiresakiNm) {
		this.siiresakiNm = siiresakiNm;
	}
	// サイズ名称
	private String sizeNm;
	public String getSizeNm() {
		return nullToEmpty(sizeNm);
	}
	...
	// 品番コード　（新規時用）
	private String hinbanCd;
	public String getHinbanCd() {
		return nullToEmpty(hinbanCd);
	}
	public void setHinbanCd(String hinbanCd) {
