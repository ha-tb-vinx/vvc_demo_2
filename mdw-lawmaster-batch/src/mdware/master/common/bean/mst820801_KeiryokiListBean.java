 ...
 * @see なし								
 */
public class mst820801_KeiryokiListBean
{
	...
	public static final int SYOMIKIKAN_VL_MAX_LENGTH			= 3;	//賞味期限の長さ
	...
	public static final int RECEIPT_HINMEI_NA_MAX_LENGTH		= 30;	//レシート区分の長さ
	public static final int TEIGAKU_UP_KB_MAX_LENGTH			= 1;	//定額・ＵＰ区分の長さ
	public static final int SYOMIKIKAN_KB_MAX_LENGTH			= 1;	//賞味期間区分の長さ
	public static final int SANTI_NB_MAX_LENGTH				= 3;	//産地番号の長さ

	public static final int KAKOJIKOKU_PRINT_KB_MAX_LENGTH	= 3;	//加工時刻印字区分の長さ
	public static final int CHORIYO_KOKOKUBUN_KB_MAX_LENGTH	= 2;	//調理用広告文の長さ
	public static final int START_KB_MAX_LENGTH				= 2;	//開始日の長さ
	public static final int EIYO_SEIBUN_NA_MAX_LENGTH		= 60;	//営業成分名称の長さ
	public static final int GENZAIRYO_NA_MAX_LENGTH			= 1728;	//原材料名称の長さ
	public static final int TENKABUTU_NA_MAX_LENGTH			= 1728;	//原材料名称の長さ
	...
	private String keiryoki2_na		= null;	//計量器名称２
	private String keiryoki3_na		= null;	//計量器名称３	
	private String back_label_kb		= null;	//添加物区分
	private String syomikikan_vl		= null;	//賞味期限
	...
	private String teigaku_up_kb			= null;	//定額・ＵＰ区分
	private String syomikikan_kb			= null;	//賞味期間区分
	...
	private String start_kb				= null;	//開始日
	private String eiyo_seibun_na			= null;	//営業成分名称
	 ...
	 */
	public static mst820801_KeiryokiListBean getMst820201_KeiryokiListBean(DataHolder dataHolder)
	{
		mst820801_KeiryokiListBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst820801_KeiryokiListDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst820801_KeiryokiListBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	...
	public String getSyomikikanVl()
	{
		return cutString(this.syomikikan_vl,SYOMIKIKAN_VL_MAX_LENGTH);
	}
	public String getSyomikikanVlString()
	{
		return "'" + cutString(this.syomikikan_vl,SYOMIKIKAN_VL_MAX_LENGTH) + "'";
	}
	public String getSyomikikanVlHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.syomikikan_vl,SYOMIKIKAN_VL_MAX_LENGTH));
	}
...
////////////////////
  ...
  // santi_nbに対するセッターとゲッターの集合
  public boolean setSantiNb(String santi_nb)
  {
	  this.santi_kb = santi_nb;
	  return true;
  }
  public String getSantiNb()
  {
	  return cutString(this.santi_kb,SANTI_NB_MAX_LENGTH);
  }
  public String getSantiNbString()
  {
	  return "'" + cutString(this.santi_kb,SANTI_NB_MAX_LENGTH) + "'";
  }
  public String getSantiNbHTMLString()
  {
	  return HTMLStringUtil.convert(cutString(this.santi_kb,SANTI_NB_MAX_LENGTH));
  }
  ...
  public String getTenkabutuNaHTMLString()
  {
	...
	public String toString()
	{
		...
		+ "  keiryoki2_na = " + getKeiryoki2NaString()
		+ "  keiryoki3_na = " + getKeiryoki3NaString()
	 ...
	 */
	public mst820801_KeiryokiListBean createClone()
	{
		...
		bean.setKeiryoki2Na(this.keiryoki2_na);
		bean.setKeiryoki3Na(this.keiryoki3_na);
