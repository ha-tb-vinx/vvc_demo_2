 ...
 * @version 1.0(2005/03/18)初版作成
 */
public class mst530501_ButuryutenpoBean
{
	...
	/**
	 * RBUTURYUTENPOBeanを１件のみ抽出したい時に使用する
	 */
	public static mst530501_ButuryutenpoBean getRBUTURYUTENPOBean(DataHolder dataHolder)
	{
		mst530501_ButuryutenpoBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst530501_ButuryutenpoDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst530501_ButuryutenpoBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return RBUTURYUTENPOBean コピー後のクラス
	 */
	public mst530501_ButuryutenpoBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst530501_ButuryutenpoBean ) ) return false;
