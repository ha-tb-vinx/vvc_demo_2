/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）ＢＯＳ発注予定検索の画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するＢＯＳ発注予定検索の画面表示データ格納用クラス</p>
 ...
 * @version 1.0(2005/03/22)初版作成
 */
public class mst900201_KeepBean
{

	private static final StcLog stcLog = StcLog.getInstance();

	////　ＢＯＳ発注予定検索画面　検索条件　////
	private String denpatu_dt 	 	 = null;	//伝発日
	...
	////　検索条件変更チェック用
	private String denpatu_dt_chk		= null;//チェック用伝発日
...
//BUGNO-S052 2005.05.14 Y.Gotoh START
	private static final String INIT_PAGE = "mst900101_SyohinItiranInit";	// 初期画面JSPを取得
	private static final String VIEW_PAGE = "mst900201_SyohinItiranView";	// 照会画面JSPを取得
...
//BUGNO-S052 2005.05.14 Y.Gotoh END
   ...
   */
  public void setDenpatuDt(String string) {
	  denpatu_dt = string;
  }
   ...
   * <br>
   * Ex)<br>
   * getDenpatuDt();　戻り値　文字列<br>
   * <br>
   * @return String 文字列
   */
  public String getDenpatuDt() {
	  return denpatu_dt;
  }
  ...
  /**
   * 伝発日に対するセッター（検索条件チェック用）<br>
   * <br>
   * Ex)<br>
   * setDenpatuDtChk("文字列");<br>
   * <br>
   * @param String 設定する文字列
   */
  public void setDenpatuDtChk(String string) {
	  denpatu_dt_chk = string;
  }

  /**
   * 伝発日に対するゲッター（検索条件チェック用）<br>
   * <br>
   * Ex)<br>
   * getDenpatuDtChk();　戻り値　文字列<br>
   * <br>
   * @return String 文字列
   */
  public String getDenpatuDtChk() {
	  return denpatu_dt_chk;
  }
