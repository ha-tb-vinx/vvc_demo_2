/**
 * <p>タイトル	：新ＭＤシステム（マスタ管理）店別品種(品種)の画面表示データ格納用クラス</p>
 * <p>説明: 	：新ＭＤシステムで使用する店別品種(品種)マスタの画面表示データ格納用クラス</p>
...
public class mst790201_KeepBean
{
	...
	private static final String INIT_PAGE = "mst790101_TenbetsuHinsyuHinsyuInit";	// 初期画面JSPを取得
	private static final String EDIT_PAGE = "mst790201_TenbetsuHinsyuHinsyuEdit";	// 新規・修正画面JSPを取得
	private static final String VIEW_PAGE = "mst790301_TenbetsuHinsyuHinsyuView";	// 照会画面JSPを取得
