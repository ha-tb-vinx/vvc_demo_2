...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）プライスシール・棚割表発行リクエスト条件の画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するプライスシール・棚割表発行リクエスト条件の画面表示データ格納用クラス</p>
 * <p>著作権: Copyright (c) 2006</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author yaoyujun
 * @version 1.0(2006/12/06)初版作成
 */
public class mstA80501_PsTanaHakkouJyokenBean {
	private static final StcLog stcLog = StcLog.getInstance();

	private String iraiNo = null;			// 依頼NO
	private String entryKb = null;		// 登録区分
	...
	private String tanadaiNb = "";//個別棚割番号
	...
	public boolean setIraiNo(String iraiNo)
	{
		this.iraiNo = iraiNo;
		return true;
	}
	...
	public boolean setEntryKb(String entryKb)
	{
