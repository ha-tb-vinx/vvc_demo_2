 ...
 * @version 1.0(2005/03/18)初版作成
 */
public class mst530401_TengroupDM extends DataModule
{
	private DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
	/**
	 * コンストラクタ
	 */
	public mst530401_TengroupDM()
	{
	...
	protected Object instanceBean( ResultSet rest )
		throws SQLException
	{
		mst530401_TengroupBean bean = new mst530401_TengroupBean();
		...
		bean.setRankNb( rest.getString("rank_nb") );
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		{
			sb.append(whereStr);
			sb.append("rank_nb >= '" + conv.convertWhereString( (String)map.get("rank_nb_bef") ) + "'");
			whereStr = andStr;
		}
		if( map.get("rank_nb_aft") != null && ((String)map.get("rank_nb_aft")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb <= '" + conv.convertWhereString( (String)map.get("rank_nb_aft") ) + "'");
			whereStr = andStr;
		}
		if( map.get("rank_nb") != null && ((String)map.get("rank_nb")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb = '" + conv.convertWhereString( (String)map.get("rank_nb") ) + "'");
			whereStr = andStr;
		}
		if( map.get("rank_nb_like") != null && ((String)map.get("rank_nb_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb like '%" + conv.convertWhereString( (String)map.get("rank_nb_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("rank_nb_bef_like") != null && ((String)map.get("rank_nb_bef_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb like '%" + conv.convertWhereString( (String)map.get("rank_nb_bef_like") ) + "'");
			whereStr = andStr;
		}
		if( map.get("rank_nb_aft_like") != null && ((String)map.get("rank_nb_aft_like")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb like '" + conv.convertWhereString( (String)map.get("rank_nb_aft_like") ) + "%'");
			whereStr = andStr;
		}
		if( map.get("rank_nb_in") != null && ((String)map.get("rank_nb_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb in ( '" + replaceAll(conv.convertWhereString( (String)map.get("rank_nb_in") ),",","','") + "' )");
			whereStr = andStr;
		}
		if( map.get("rank_nb_not_in") != null && ((String)map.get("rank_nb_not_in")).trim().length() > 0 )
		{
			sb.append(whereStr);
			sb.append("rank_nb not in ( '" + replaceAll(conv.convertWhereString( (String)map.get("rank_nb_not_in") ),",","','") + "' )");
			whereStr = andStr;
		}
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		mst530401_TengroupBean bean = (mst530401_TengroupBean)beanMst;
		StringBuffer sb = new StringBuffer();
		...
		if( bean.getRankNb() != null && bean.getRankNb().trim().length() != 0 )
		{
			if( befKanma ) sb.append(","); else befKanma = true;
			sb.append(" rank_nb");
		}
		...
		{
			if( aftKanma ) sb.append(","); else aftKanma = true;
			sb.append("'" + conv.convertString( bean.getRankNb() ) + "'");
		}
		if( bean.getInsertTs() != null && bean.getInsertTs().trim().length() != 0 )
		{
			if( aftKanma ) sb.append(","); else aftKanma = true;
