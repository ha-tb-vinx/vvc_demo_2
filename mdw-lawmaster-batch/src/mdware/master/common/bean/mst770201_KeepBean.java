/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）単品一括送信画面の画面情報格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する単品一括送信画面の画面情報格納用クラス</p>
 ...
 * @version 1.0(2005/04/21)初版作成
 */
public class mst770201_KeepBean
{
...
//	↑↑2007.01.24 H.Yamamoto カスタマイズ修正↑↑
	...
	private String request_kb			= "";				//条件区分
	private String syori_kb            = "";				//処理区分
//  ↓↓2006.06.23 lulh カスタマイズ修正↓↓
...
//	↓↓2007.01.24 H.Yamamoto カスタマイズ修正↓↓
	...
	/**
	 * @param gyosyu_sel_flg gyosyu_sel_flg を設定。
	 */
...
//	↑↑2007.01.24 H.Yamamoto カスタマイズ修正↑↑
    ...
    /**
     * @param request_kb request_kb を設定。
     */
    public void setRequestKb(String request_kb) {
...
//   ↑↑2006.06.22 lulh カスタマイズ修正↑↑
	...
	public boolean isBackgroundListSelected() {
		...
		for (int i = 0; i < meisai.size(); i++) {
			mst770301_TanpinSendListBean bean = (mst770301_TanpinSendListBean)meisai.get(i);
