/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）キーPLUマスタのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するキーPLUマスタのレコード格納用クラス(DmCreatorにより自動生成)</p>
...
/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）キーPLUマスタのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するキーPLUのレコード格納用クラス(DmCreatorにより自動生成)</p>
 * <p>著作権: Copyright (c) 2005</p>
 * <p>会社名: Vinculum Japan Corp.</p>
 * @author FSIABC E.Yoshikawa
 * @version 1.0(2005/04/13)初版作成
 */
public class mst710101_KeyPluBean
{
	...
	/**
	 * mst710101_KeyPluBeanを１件のみ抽出したい時に使用する
	 */
	public static mst710101_KeyPluBean getmst710101_KeyPluBean(DataHolder dataHolder)
	{
		mst710101_KeyPluBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst710101_KeyPluDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst710101_KeyPluBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 */
	public mst710101_KeyPluBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst710101_KeyPluBean ) ) return false;
