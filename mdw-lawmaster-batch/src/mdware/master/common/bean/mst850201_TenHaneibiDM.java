 ...
 * @version 1.0(2005/03/11)初版作成
 */
public class mst850201_TenHaneibiDM extends DataModule
{
	private DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
	/**
	 * コンストラクタ
	 */
	public mst850201_TenHaneibiDM()
	{
	...
	protected Object instanceBean( ResultSet rest )
		throws SQLException
	{
		mst850201_TenHaneibiBean bean = new mst850201_TenHaneibiBean();
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		sb.append(", ");
		sb.append("delete_fg ");
		sb.append("from r_theme_tenhaneibi ");
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		mst850201_TenHaneibiBean bean = (mst850201_TenHaneibiBean)beanMst;
		StringBuffer sb = new StringBuffer();
		sb.append("insert into ");
		sb.append("r_theme_tenhaneibi (");
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		StringBuffer sb = new StringBuffer();
		sb.append("update ");
		sb.append("r_theme_tenhaneibi set ");
		if( bean.getHaneiDt() != null && bean.getHaneiDt().trim().length() != 0 )
		{
			befKanma = true;
			sb.append(" hanei_dt = ");
...
//		DBStringConvert conv = DBStringConvert.getDBStringConvert( getDatabaseProductName() );
		...
		sb.append("r_theme_tenhaneibi where ");
		sb.append(" s_gyosyu_cd = ");
		sb.append("'" + conv.convertWhereString( bean.getSGyosyuCd() ) + "'");
		sb.append(" AND");
		sb.append(" theme_cd = ");
