/**
 * <P>タイトル : 新ＭＤシステム　マスターメンテナンス  mst180301用店別例外マスタの画面項目(一覧)格納用クラス</P>
 * <P>説明 : 新ＭＤシステムで使用するmst180301用店別例外マスタの画面項目格納用クラス</P>
 ...
 * @see なし								
 */
public class mst180301_KeepMeisaiBean
{
	private static final StcLog stcLog = StcLog.getInstance();

	private ArrayList SyohinMeisai	= new ArrayList();	// 商品一覧の明細
	private ArrayList Meisai	= new ArrayList();	// 一覧の明細
	
//	↓↓2006.07.14 shijun カスタマイズ修正↓↓
...
//	↑↑2006.07.14 shijun カスタマイズ修正↑↑
	...
	// SyohinMeisaiに対するセッターとゲッターの集合
	public boolean setSyohinMeisai(ArrayList Meisai) {
		this.SyohinMeisai = Meisai;
		return true;
	}
	
	public ArrayList getSyohinMeisai() {
		return this.SyohinMeisai;
	}
