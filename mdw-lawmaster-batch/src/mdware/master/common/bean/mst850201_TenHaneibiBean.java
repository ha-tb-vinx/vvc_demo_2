/**
 * <p>タイトル: 新ＭＤシステム（マスター管理）テーマ別店反映日マスタのレコード格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用するテーマ別店反映日マスタのレコード格納用クラス(DmCreatorにより自動生成)</p>
 ...
 * @version 1.0(2005/03/11)初版作成
 */
public class mst850201_TenHaneibiBean
{
	...
	/**
	 * RThemeTenhaneibiBeanを１件のみ抽出したい時に使用する
	 */
	public static mst850201_TenHaneibiBean getRThemeTenhaneibiBean(DataHolder dataHolder)
	{
		mst850201_TenHaneibiBean bean = null;
		BeanHolder beanHolder = new BeanHolder( new mst850201_TenHaneibiDM() );
		try
		{
			Iterator ite = beanHolder.getPageBeanListFromDataHolder( dataHolder ).iterator();
			//１件以上存在する時はまず保存する
			if( ite.hasNext() )
				bean = (mst850201_TenHaneibiBean )ite.next();
			//２件以上存在する時はＮＵＬＬにする
			if( ite.hasNext() )
				bean = null;
		}
	 ...
	 * @return mst850201_TenHaneibiBean コピー後のクラス
	 */
	public mst850201_TenHaneibiBean createClone()
	{
	...
	public boolean equals( Object o )
	{
		...
		if( !( o instanceof mst850201_TenHaneibiBean ) ) return false;
