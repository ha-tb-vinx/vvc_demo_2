 ...
 * <P>説明 : 新ＭＤシステムで使用する mst600101_Jidohaiban用計量器マスタのレコード格納用クラス</P>
 ...
 * <P>説明 : 新ＭＤシステムで使用するmst600101_Jidohaiban用自動廃番制御マスタのレコード格納用クラス</P>
 * <P>著作権: Copyright (c) 2005</p>								
 * <P>会社名: Vinculum Japan Corp.</P>								
 * @author C.Sawabe
 ...
 * @see なし								
 */
public class mst600201_KeepBean {

	/**
	 * 
	 */
	public mst600201_KeepBean() {
	}
	...
	//明細Bean
	public mst600401_KeepMeisaiBean meisaiBean = null;
...
//	public mst600201_KeepBean (mst000501_SysSosasyaBean sysUserBean) {
	public mst600201_KeepBean (MdwareUserSessionBean sysUserBean) {		
//		 ↑↑2006.06.23 wangluping カスタマイズ修正↑↑		
		this.user_id     = sysUserBean.getUserId();							//ログインユーザー
		this.meisaiList  = new ArrayList();								//一覧の明細
		this.meisaiBh    = new BeanHolder(new mst600101_JidohaibanLDM());	//検索結果格納BeanHolder
		this.meisaiBean  = new mst600401_KeepMeisaiBean();					//明細Bean
	...
	/**
	 * mst600401_KeepMeisaiBean
	 * @param i
	 * @return
	 */	
	public mst600401_KeepMeisaiBean getMeisaiList(int i) {
		this.meisaiBean = (mst600401_KeepMeisaiBean) this.meisaiList.get(i);
	 ...
	 * @param bean
	 */
	public boolean setMeisaiBean(mst600401_KeepMeisaiBean bean) {
		this.meisaiBean = bean;
		return true;
	}
	public mst600401_KeepMeisaiBean getMeisaiBean() {
		return this.meisaiBean;
	}
