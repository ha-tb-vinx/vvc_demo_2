/**
 * <p>タイトル: 新ＭＤシステム（マスター管理） 商品マスタ登録（タグ）の画面表示データ格納用クラス</p>
 * <p>説明: 新ＭＤシステムで使用する  商品マスタ登録（タグ）の画面表示データ格納用クラス</p>
 ...
 * 　　　　　　　　酒税報告区分(syuzei_hokoku_kb)⇒1桁→2桁⇒5桁
 ...
 * @version 1.0(2005/04/04)初版作成
 * @version 1.1(2005/05/11)新ER対応
 * 　　　　　追加…発注商品区分(hacyu_syohin_kb)、システム区分(system_kb)、値札枚数(tag_hako_qt)、
 * 　　　　　　　　マスタ使用不可区分(mst_siyofuka_kb)、税区分(zei_kb)、販売期間区分(hanbai_kikan_kb)
 * 　　　　　削除…店配送先管理コード(ten_haiso_kanri_cd)
 * 　　　　　修正…仕入品番(siire_hinban_cd)⇒13桁→15桁
 * 　　　　　　　　代表配送先コード(daihyo_haiso_cd)⇒5桁→4桁
 ...
 * 　　　　　　　　入荷商品コード(nyuka_syohin_cd)⇒3件→13桁
 */
public class mst110201_KeepBean
{
...
// ↑↑ DB変更に伴う対応(2005.09.18 Y.Inaba)
	...
	public static final int YORIDORI_QT_MAX_LENGTH 				= 5;	//よりどり数量の長さ
...
//	↓↓2006.06.26 zhujl カスタマイズ修正↓↓
	...
	public static final int HAIFU_CD_MAX_LENGTH = 2;//配布コード
	public static final int SUBCLASS_CD_MAX_LENGTH = 5;//サブクラスコード
	...
	public static final int NEFUDA_UKEWATASI_DT_MAX_LENGTH = 8;//タグ受渡日
//	↑↑2006.06.26 zhujl カスタマイズ修正↑↑
...
//	2006.01.27 T.hattori　追加　終了　先付け登録項目追加
	...
	private String kikaku_kanji2_na 		 = "";				//漢字規格２
	private String hinmei_kana_na 			 = "";				//カナ品名
	private String kikaku_kana_na 			 = "";				//カナ規格
	private String kikaku_kana2_na 		 = "";				//カナ規格２
	...
	private String tag_hako_qt				 = "";				//タグ発行枚数
...
//	↓↓仕様変更（2005.08.18）↓↓
	private String size_na					 = "";				//サイズ名称
//	↑↑仕様変更（2005.08.18）↑↑
	private String color_cd 				 = "";					//カラーコード
	private String color_na 				 = "";					//カラー名称
...
//	↓↓仕様追加による変更（2005.06.29）↓↓
	...
	private String daichotenpo = null;
	private String daichohonbu = null;
	private String daichosiiresaki = null;
	private String honbu_zai_kb = null;	//本部在庫区分
...
//	↓↓2006.06.26 zhujl カスタマイズ修正↓↓
	...
	private String haifu_cd = null;//配布コード
	private String subclass_cd = null;//サブクラスコード
	private String subclass_na = null;//サブクラス名称
	private String sode_cd = null;//袖丈
	...
	private String pb_kb = null;//PB区分
	private String yoridori_vl = null;//よりどり価格
	private String nefuda_ukewatasi_dt = null;//タグ受渡日
	private String nefuda_ukewatasi_kb = null;//タグ受渡方法
...
//	↑↑2006.06.26 zhujl カスタマイズ修正↑↑
	...
	private static final String INIT_PAGE   = "mst110101_SyohinIryouHatiketaInit";	//初期画面JSPを取得
	private static final String EDIT_PAGE   = "mst110201_SyohinIryouHatiketaEdit";	//新規・修正画面JSPを取得
	private static final String VIEW_PAGE   = "mst110301_SyohinIryouHatiketaView";	//削除・照会画面JSPを取得
...
//	↑↑2006.06.26 zhujl カスタマイズ修正↑↑
	...
	// kikaku_kanji2_naに対するセッターとゲッターの集合
	public boolean setKikakuKanji2Na(String kikaku_kanji2_na)
	{
		this.kikaku_kanji2_na = kikaku_kanji2_na;
		return true;
	}
	public String getKikakuKanji2Na()
	{
		return this.kikaku_kanji2_na;
	}
	// kikaku_kana2_naに対するセッターとゲッターの集合
	public boolean setKikakuKana2Na(String kikaku_kana2_na)
	{
		this.kikaku_kana2_na = kikaku_kana2_na;
		return true;
	}
	public String getKikakuKana2Na()
	{
		return this.kikaku_kana2_na;
	}
...
//	 color_naに対するセッターとゲッターの集合
	...
	{
		return HTMLStringUtil.convert(this.color_na);
	}
//↑↑2006.06.26 zhujl カスタマイズ修正↑↑
...
//	↓↓2006.06.26 zhujl カスタマイズ修正↓↓
	...
	public boolean setSubclassNa(String subclass_na)
	{
		this.subclass_na = subclass_na;
		return true;
	}
	public String getSubclassNa()
	{
		return cutString(this.subclass_na,SUBCLASS_NA_MAX_LENGTH);
	}
	public String getSubclassNaString()
	{
		return "'" + cutString(this.subclass_na,SUBCLASS_NA_MAX_LENGTH) + "'";
	}
	public String getSubclassNaHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.subclass_na,SUBCLASS_NA_MAX_LENGTH));
	}
	...
	{
		return HTMLStringUtil.convert(this.sode_cd);
	}
	...
	{
		return "'" + cutString(this.tokubetu_genka_vl,TOKUBETU_GENKA_VL_MAX_LENGTH) + "'";
	}
	public String getTokubetuGenkaVlHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.tokubetu_genka_vl,TOKUBETU_GENKA_VL_MAX_LENGTH));
	}
	...
	public String getKeshiBaikaVlHTMLString()
	{
	...
	{
		return cutString(this.konkai_tuikeiyaku_qt,KONKAI_TUIKEIYAKU_QT_MAX_LENGTH);
	}
	...
	{
		return this.nefuda_ukewatasi_kb;
	}
	...
	{
		return HTMLStringUtil.convert(this.nefuda_ukewatasi_kb);
	}
	...
	{
		return cutString(this.yoridori_vl,YORIDORI_VL_MAX_LENGTH);
	}
	public String getYoridoriVlString()
	{
		return "'" + cutString(this.yoridori_vl,YORIDORI_VL_MAX_LENGTH) + "'";
	}
	public String getYoridoriVlHTMLString()
	{
		return HTMLStringUtil.convert(cutString(this.yoridori_vl,YORIDORI_VL_MAX_LENGTH));
	}
