 ...
 * 集計品種マスタ登録画面表示用のBean
 */
public class mst640201_KeepBean {
    ...
    private String StartNo = ""; 				// 開始集計品種コード
    private String SyukeiSyubetuCd = ""; 		// 集計種別コード
    private String KanjiNa = ""; 				// 集計種別名称
	private String gyosyuKb = ""; 				// 業種区分
	private String ProcessingDivision = ""; 	// 処理区分
    ...
    private String SyubetuInputChk = "";		//集計種別コードの入力チェック
	...
	public String getGyosyuKb() {
		return this.gyosyuKb;
	}

	/**
	 * 業種区分のゲッター
	 */
	public void setGyosyuKb(String gyosyukb) {
		this.gyosyuKb = gyosyukb;
	}
