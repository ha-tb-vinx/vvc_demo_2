 ...
 */
public abstract class SyohinSubCheckAbstract implements InterfaceCheck {	
...
// ===END=== Add by kou 2006/8/10
	
   //===BEGIN=== Add by kou 2006/11/29
   private PreparedStatement syohinSelectPstmt = null;	//商品マスタ検索用PreparedStatement
   //===END=== Add by kou 2006/11/29

// ↓↓2006.12.15 H.Yamamoto パンチデータ対策修正↓↓
...
// ↑↑2007.02.05 H.Yamamoto カスタマイズ修正↑↑
	 ...
	 * @throws SQLException
	 */
	public SyohinSubCheckAbstract(MasterDataBase dataBase) throws SQLException {
		// データベース設定
...
//		System.out.println(key[0] + "	" + key[1] + "	" + key[2] + "	" + key[3] + "	" + key[4] + "	" + key[5]);
	 ...
	 * @throws SQLException
	 */
	public void setTRKey(String syubetu) throws SQLException {
		String[] key = new String[6]; // キー項目
